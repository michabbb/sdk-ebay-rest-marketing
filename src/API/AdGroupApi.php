...
class AdGroupApi
{
     ...
     * @return object
     */
    public function createAdGroup($campaignId, $createAdGroupRequest, string $contentType = self::contentTypes['createAdGroup'][0])
    {
        list($response) = $this->createAdGroupWithHttpInfo($campaignId, $createAdGroupRequest, $contentType);
        return $response;
    }
     ...
     */
    public function createAdGroupWithHttpInfo($campaignId, $createAdGroupRequest, string $contentType = self::contentTypes['createAdGroup'][0])
    {
        $request = $this->createAdGroupRequest($campaignId, $createAdGroupRequest, $contentType);
     ...
     */
    public function createAdGroupAsync($campaignId, $createAdGroupRequest, string $contentType = self::contentTypes['createAdGroup'][0])
    {
        return $this->createAdGroupAsyncWithHttpInfo($campaignId, $createAdGroupRequest, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createAdGroupAsyncWithHttpInfo($campaignId, $createAdGroupRequest, string $contentType = self::contentTypes['createAdGroup'][0])
    {
        $returnType = 'object';
        $request = $this->createAdGroupRequest($campaignId, $createAdGroupRequest, $contentType);
     ...
     */
    public function createAdGroupRequest($campaignId, $createAdGroupRequest, string $contentType = self::contentTypes['createAdGroup'][0])
    {
     ...
     * @param  string|null $adGroupStatus A comma-separated list of ad group statuses. The results will be filtered to only include the given statuses of the ad group.&lt;br&gt;&lt;br&gt; See &lt;a href&#x3D;\&quot;/api-docs/sell/marketing/types/pls:AdGroupStatusEnum\&quot; target&#x3D;\&quot;_blank\&quot;&gt;AdGroupStatusEnum&lt;/a&gt; for supported values. (optional)
     ...
     */
    public function suggestBids($adGroupId, $campaignId, $targetedBidRequest, string $contentType = self::contentTypes['suggestBids'][0])
    {
        list($response) = $this->suggestBidsWithHttpInfo($adGroupId, $campaignId, $targetedBidRequest, $contentType);
        return $response;
    }
     ...
     */
    public function suggestBidsWithHttpInfo($adGroupId, $campaignId, $targetedBidRequest, string $contentType = self::contentTypes['suggestBids'][0])
    {
        $request = $this->suggestBidsRequest($adGroupId, $campaignId, $targetedBidRequest, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function suggestBidsAsync($adGroupId, $campaignId, $targetedBidRequest, string $contentType = self::contentTypes['suggestBids'][0])
    {
        return $this->suggestBidsAsyncWithHttpInfo($adGroupId, $campaignId, $targetedBidRequest, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function suggestBidsAsyncWithHttpInfo($adGroupId, $campaignId, $targetedBidRequest, string $contentType = self::contentTypes['suggestBids'][0])
    {
        $returnType = '\macropage\SDKs\ebay\rest\marketing\Model\TargetedBidsPagedCollection';
        $request = $this->suggestBidsRequest($adGroupId, $campaignId, $targetedBidRequest, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function suggestBidsRequest($adGroupId, $campaignId, $targetedBidRequest, string $contentType = self::contentTypes['suggestBids'][0])
    {
     ...
     * @param  \macropage\SDKs\ebay\rest\marketing\Model\TargetedKeywordRequest|null $targetedKeywordRequest The required data to retrieve suggested keywords. (optional)
     ...
     */
    public function suggestKeywords($adGroupId, $campaignId, $targetedKeywordRequest = null, string $contentType = self::contentTypes['suggestKeywords'][0])
    {
        list($response) = $this->suggestKeywordsWithHttpInfo($adGroupId, $campaignId, $targetedKeywordRequest, $contentType);
        return $response;
    }
     ...
     */
    public function suggestKeywordsWithHttpInfo($adGroupId, $campaignId, $targetedKeywordRequest = null, string $contentType = self::contentTypes['suggestKeywords'][0])
    {
        $request = $this->suggestKeywordsRequest($adGroupId, $campaignId, $targetedKeywordRequest, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function suggestKeywordsAsync($adGroupId, $campaignId, $targetedKeywordRequest = null, string $contentType = self::contentTypes['suggestKeywords'][0])
    {
        return $this->suggestKeywordsAsyncWithHttpInfo($adGroupId, $campaignId, $targetedKeywordRequest, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function suggestKeywordsAsyncWithHttpInfo($adGroupId, $campaignId, $targetedKeywordRequest = null, string $contentType = self::contentTypes['suggestKeywords'][0])
    {
        $returnType = '\macropage\SDKs\ebay\rest\marketing\Model\TargetedKeywordsPagedCollection';
        $request = $this->suggestKeywordsRequest($adGroupId, $campaignId, $targetedKeywordRequest, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function suggestKeywordsRequest($adGroupId, $campaignId, $targetedKeywordRequest = null, string $contentType = self::contentTypes['suggestKeywords'][0])
    {
     ...
     * @return void
     */
    public function updateAdGroup($adGroupId, $campaignId, $updateAdGroupRequest, string $contentType = self::contentTypes['updateAdGroup'][0])
    {
        $this->updateAdGroupWithHttpInfo($adGroupId, $campaignId, $updateAdGroupRequest, $contentType);
    }
     ...
     */
    public function updateAdGroupWithHttpInfo($adGroupId, $campaignId, $updateAdGroupRequest, string $contentType = self::contentTypes['updateAdGroup'][0])
    {
        $request = $this->updateAdGroupRequest($adGroupId, $campaignId, $updateAdGroupRequest, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateAdGroupAsync($adGroupId, $campaignId, $updateAdGroupRequest, string $contentType = self::contentTypes['updateAdGroup'][0])
    {
        return $this->updateAdGroupAsyncWithHttpInfo($adGroupId, $campaignId, $updateAdGroupRequest, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateAdGroupAsyncWithHttpInfo($adGroupId, $campaignId, $updateAdGroupRequest, string $contentType = self::contentTypes['updateAdGroup'][0])
    {
        $returnType = '';
        $request = $this->updateAdGroupRequest($adGroupId, $campaignId, $updateAdGroupRequest, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateAdGroupRequest($adGroupId, $campaignId, $updateAdGroupRequest, string $contentType = self::contentTypes['updateAdGroup'][0])
    {
