...
class EmailCampaignApi
{
     ...
     */
    public function createEmailCampaign($xEBAYCMARKETPLACEID, $createEmailCampaignRequest, string $contentType = self::contentTypes['createEmailCampaign'][0])
    {
        list($response) = $this->createEmailCampaignWithHttpInfo($xEBAYCMARKETPLACEID, $createEmailCampaignRequest, $contentType);
        return $response;
    }
     ...
     */
    public function createEmailCampaignWithHttpInfo($xEBAYCMARKETPLACEID, $createEmailCampaignRequest, string $contentType = self::contentTypes['createEmailCampaign'][0])
    {
        $request = $this->createEmailCampaignRequest($xEBAYCMARKETPLACEID, $createEmailCampaignRequest, $contentType);
     ...
     */
    public function createEmailCampaignAsync($xEBAYCMARKETPLACEID, $createEmailCampaignRequest, string $contentType = self::contentTypes['createEmailCampaign'][0])
    {
        return $this->createEmailCampaignAsyncWithHttpInfo($xEBAYCMARKETPLACEID, $createEmailCampaignRequest, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createEmailCampaignAsyncWithHttpInfo($xEBAYCMARKETPLACEID, $createEmailCampaignRequest, string $contentType = self::contentTypes['createEmailCampaign'][0])
    {
        $returnType = '\macropage\SDKs\ebay\rest\marketing\Model\CreateEmailCampaignResponse';
        $request = $this->createEmailCampaignRequest($xEBAYCMARKETPLACEID, $createEmailCampaignRequest, $contentType);
     ...
     */
    public function createEmailCampaignRequest($xEBAYCMARKETPLACEID, $createEmailCampaignRequest, string $contentType = self::contentTypes['createEmailCampaign'][0])
    {
     ...
     * @param  string|null $limit The maximum number of audience groups returned per page in the results set.&lt;br&gt;&lt;br&gt;&lt;b&gt;Min value&lt;/b&gt;: 1&lt;br&gt;&lt;br&gt;&lt;b&gt;Max value&lt;/b&gt;: 200&lt;br&gt;&lt;br&gt;&lt;b&gt;Default value&lt;/b&gt;: 100 (optional)
     * @param  string|null $offset The number of results to skip in a pagination query. This value cannot be less than 0.&lt;br&gt;&lt;br&gt;&lt;b&gt;Default value&lt;/b&gt;: 0 (optional)
     ...
     *
     * @param  string|null $limit The maximum number of email campaigns returned in a page.&lt;br&gt;&lt;br&gt;&lt;b&gt;Min value&lt;/b&gt;: 1&lt;br&gt;&lt;br&gt;&lt;b&gt;Max value&lt;/b&gt;: 200 (optional)
     * @param  string|null $offset The number of results to skip in a pagination query. This value cannot be less than zero.&lt;br&gt;&lt;br&gt;&lt;b&gt;Default value&lt;/b&gt;: 0 (optional)
     * @param  string|null $q This field contains filter criteria for the results returned. Filter by &lt;a href&#x3D;\&quot;/api-docs/sell/marketing/types/api:CampaignTypeEnum\&quot;&gt;email campaign type&lt;/a&gt;, &lt;a href&#x3D;\&quot;/api-docs/sell/marketing/types/api:EmailCampaignStatusEnum\&quot;&gt;email campaign status&lt;/a&gt;, and &lt;a href&#x3D;\&quot;/api-docs/sell/marketing/types/ba:MarketplaceIdEnum\&quot;&gt;marketplace ID&lt;/a&gt;.&lt;br&gt;&lt;br&gt;For example, setting &lt;code&gt;q&#x3D;campaignType:WELCOME,ITEM_SHOWCASE&lt;/code&gt; will return only Welcome and Item Showcase email campaigns.&lt;br&gt;&lt;br&gt;&lt;span class&#x3D;\&quot;tablenote\&quot;&gt;&lt;b&gt;Note:&lt;/b&gt; At least one &lt;code&gt;campaignType&lt;/code&gt; value must be set through the &lt;code&gt;q&lt;/code&gt; query parameter. If no other filters are set, all email campaigns for the specified campaign type(s) will be returned in the results set.&lt;/span&gt; (optional)
     * @param  string|null $sort The criteria for sorting email campaign results. See &lt;a href&#x3D;\&quot;/api-docs/sell/marketing/types/api:ItemSortEnum\&quot; target&#x3D;\&quot;_blank\&quot;&gt;ItemSortEnum&lt;/a&gt; for sorting options and their enum values.&lt;br&gt;&lt;br&gt;&lt;b&gt;Default&lt;/b&gt;: &lt;code&gt;NEWLY_LISTED&lt;/code&gt; (optional)
     ...
     */
    public function updateEmailCampaign($emailCampaignId, $updateCampaignRequest, string $contentType = self::contentTypes['updateEmailCampaign'][0])
    {
        list($response) = $this->updateEmailCampaignWithHttpInfo($emailCampaignId, $updateCampaignRequest, $contentType);
        return $response;
    }
     ...
     */
    public function updateEmailCampaignWithHttpInfo($emailCampaignId, $updateCampaignRequest, string $contentType = self::contentTypes['updateEmailCampaign'][0])
    {
        $request = $this->updateEmailCampaignRequest($emailCampaignId, $updateCampaignRequest, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateEmailCampaignAsync($emailCampaignId, $updateCampaignRequest, string $contentType = self::contentTypes['updateEmailCampaign'][0])
    {
        return $this->updateEmailCampaignAsyncWithHttpInfo($emailCampaignId, $updateCampaignRequest, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateEmailCampaignAsyncWithHttpInfo($emailCampaignId, $updateCampaignRequest, string $contentType = self::contentTypes['updateEmailCampaign'][0])
    {
        $returnType = '\macropage\SDKs\ebay\rest\marketing\Model\UpdateEmailCampaignResponse';
        $request = $this->updateEmailCampaignRequest($emailCampaignId, $updateCampaignRequest, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateEmailCampaignRequest($emailCampaignId, $updateCampaignRequest, string $contentType = self::contentTypes['updateEmailCampaign'][0])
    {
