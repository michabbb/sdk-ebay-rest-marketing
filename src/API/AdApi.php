...
use macropage\SDKs\ebay\rest\marketing\Model\Ad;
use macropage\SDKs\ebay\rest\marketing\Model\AdIds;
use macropage\SDKs\ebay\rest\marketing\Model\AdPagedCollectionResponse;
use macropage\SDKs\ebay\rest\marketing\Model\AdReferences;
use macropage\SDKs\ebay\rest\marketing\Model\Ads;
use macropage\SDKs\ebay\rest\marketing\Model\BulkAdResponse;
use macropage\SDKs\ebay\rest\marketing\Model\BulkAdUpdateResponse;
use macropage\SDKs\ebay\rest\marketing\Model\BulkAdUpdateStatusByListingIdResponse;
use macropage\SDKs\ebay\rest\marketing\Model\BulkAdUpdateStatusResponse;
use macropage\SDKs\ebay\rest\marketing\Model\BulkCreateAdRequest;
use macropage\SDKs\ebay\rest\marketing\Model\BulkCreateAdsByInventoryReferenceRequest;
use macropage\SDKs\ebay\rest\marketing\Model\BulkCreateAdsByInventoryReferenceResponse;
use macropage\SDKs\ebay\rest\marketing\Model\BulkDeleteAdRequest;
use macropage\SDKs\ebay\rest\marketing\Model\BulkDeleteAdResponse;
use macropage\SDKs\ebay\rest\marketing\Model\BulkDeleteAdsByInventoryReferenceRequest;
use macropage\SDKs\ebay\rest\marketing\Model\BulkDeleteAdsByInventoryReferenceResponse;
use macropage\SDKs\ebay\rest\marketing\Model\BulkUpdateAdsByInventoryReferenceResponse;
use macropage\SDKs\ebay\rest\marketing\Model\BulkUpdateAdStatusByListingIdRequest;
use macropage\SDKs\ebay\rest\marketing\Model\BulkUpdateAdStatusRequest;
use macropage\SDKs\ebay\rest\marketing\Model\CreateAdRequest;
use macropage\SDKs\ebay\rest\marketing\Model\CreateAdsByInventoryReferenceRequest;
use macropage\SDKs\ebay\rest\marketing\Model\DeleteAdsByInventoryReferenceRequest;
use macropage\SDKs\ebay\rest\marketing\Model\UpdateBidPercentageRequest;
...
class AdApi
{
     ...
     * @param  BulkCreateAdsByInventoryReferenceRequest $bulkCreateAdsByInventoryReferenceRequest The container for the bulk request to create ads for eBay inventory reference IDs. eBay inventory reference IDs are seller-defined IDs used by theInventory API. (required)
     ...
     */
    public function bulkCreateAdsByInventoryReference($campaignId, $bulkCreateAdsByInventoryReferenceRequest, string $contentType = self::contentTypes['bulkCreateAdsByInventoryReference'][0])
    {
        [$response] = $this->bulkCreateAdsByInventoryReferenceWithHttpInfo($campaignId, $bulkCreateAdsByInventoryReferenceRequest, $contentType);
        return $response;
    }
     ...
     */
    public function bulkCreateAdsByInventoryReferenceWithHttpInfo($campaignId, $bulkCreateAdsByInventoryReferenceRequest, string $contentType = self::contentTypes['bulkCreateAdsByInventoryReference'][0])
    {
        $request = $this->bulkCreateAdsByInventoryReferenceRequest($campaignId, $bulkCreateAdsByInventoryReferenceRequest, $contentType);
     ...
     */
    public function bulkCreateAdsByInventoryReferenceAsync($campaignId, $bulkCreateAdsByInventoryReferenceRequest, string $contentType = self::contentTypes['bulkCreateAdsByInventoryReference'][0])
    {
        return $this->bulkCreateAdsByInventoryReferenceAsyncWithHttpInfo($campaignId, $bulkCreateAdsByInventoryReferenceRequest, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return PromiseInterface
     */
    public function bulkCreateAdsByInventoryReferenceAsyncWithHttpInfo($campaignId, $bulkCreateAdsByInventoryReferenceRequest, string $contentType = self::contentTypes['bulkCreateAdsByInventoryReference'][0])
    {
        $returnType = '\macropage\SDKs\ebay\rest\marketing\Model\BulkCreateAdsByInventoryReferenceResponse';
        $request = $this->bulkCreateAdsByInventoryReferenceRequest($campaignId, $bulkCreateAdsByInventoryReferenceRequest, $contentType);
     ...
     * @return Request
     */
    public function bulkCreateAdsByInventoryReferenceRequest($campaignId, $bulkCreateAdsByInventoryReferenceRequest, string $contentType = self::contentTypes['bulkCreateAdsByInventoryReference'][0])
    {
        ...
        if (isset($bulkCreateAdsByInventoryReferenceRequest)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($bulkCreateAdsByInventoryReferenceRequest));
            } else {
     ...
     *
     * @param  string $campaignId This path parameter specifies the unique eBay-assigned identifier of the ad campaign for which to associated the ads being created.&lt;br&gt;&lt;br&gt; Use the &lt;a href&#x3D;\&quot;/api-docs/sell/marketing/resources/campaign/methods/getCampaigns\&quot; target&#x3D;\&quot;_blank\&quot;&gt;getCampaigns&lt;/a&gt; method to retrieve campaign IDs. (required)
     * @param  BulkCreateAdRequest $bulkCreateAdRequest The container for the bulk request to create ads for eBay listing IDs. eBay listing IDs are generated by the Trading API and Inventory API when the listing is created on eBay. (required)
     ...
     */
    public function bulkCreateAdsByListingId($campaignId, $bulkCreateAdRequest, string $contentType = self::contentTypes['bulkCreateAdsByListingId'][0])
    {
        [$response] = $this->bulkCreateAdsByListingIdWithHttpInfo($campaignId, $bulkCreateAdRequest, $contentType);
        return $response;
    }
     ...
     */
    public function bulkCreateAdsByListingIdWithHttpInfo($campaignId, $bulkCreateAdRequest, string $contentType = self::contentTypes['bulkCreateAdsByListingId'][0])
    {
        $request = $this->bulkCreateAdsByListingIdRequest($campaignId, $bulkCreateAdRequest, $contentType);
     ...
     * @return PromiseInterface
     */
    public function bulkCreateAdsByListingIdAsync($campaignId, $bulkCreateAdRequest, string $contentType = self::contentTypes['bulkCreateAdsByListingId'][0])
    {
        return $this->bulkCreateAdsByListingIdAsyncWithHttpInfo($campaignId, $bulkCreateAdRequest, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return PromiseInterface
     */
    public function bulkCreateAdsByListingIdAsyncWithHttpInfo($campaignId, $bulkCreateAdRequest, string $contentType = self::contentTypes['bulkCreateAdsByListingId'][0])
    {
        $returnType = '\macropage\SDKs\ebay\rest\marketing\Model\BulkAdResponse';
        $request = $this->bulkCreateAdsByListingIdRequest($campaignId, $bulkCreateAdRequest, $contentType);
     ...
     * @return Request
     */
    public function bulkCreateAdsByListingIdRequest($campaignId, $bulkCreateAdRequest, string $contentType = self::contentTypes['bulkCreateAdsByListingId'][0])
    {
        ...
        if (isset($bulkCreateAdRequest)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($bulkCreateAdRequest));
            } else {
     ...
     */
    public function bulkDeleteAdsByInventoryReference($campaignId, $bulkDeleteAdsByInventoryReferenceRequest, string $contentType = self::contentTypes['bulkDeleteAdsByInventoryReference'][0])
    {
        [$response] = $this->bulkDeleteAdsByInventoryReferenceWithHttpInfo($campaignId, $bulkDeleteAdsByInventoryReferenceRequest, $contentType);
        return $response;
    }
     ...
     */
    public function bulkDeleteAdsByInventoryReferenceWithHttpInfo($campaignId, $bulkDeleteAdsByInventoryReferenceRequest, string $contentType = self::contentTypes['bulkDeleteAdsByInventoryReference'][0])
    {
        $request = $this->bulkDeleteAdsByInventoryReferenceRequest($campaignId, $bulkDeleteAdsByInventoryReferenceRequest, $contentType);
     ...
     * @return PromiseInterface
     */
    public function bulkDeleteAdsByInventoryReferenceAsync($campaignId, $bulkDeleteAdsByInventoryReferenceRequest, string $contentType = self::contentTypes['bulkDeleteAdsByInventoryReference'][0])
    {
        return $this->bulkDeleteAdsByInventoryReferenceAsyncWithHttpInfo($campaignId, $bulkDeleteAdsByInventoryReferenceRequest, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return PromiseInterface
     */
    public function bulkDeleteAdsByInventoryReferenceAsyncWithHttpInfo($campaignId, $bulkDeleteAdsByInventoryReferenceRequest, string $contentType = self::contentTypes['bulkDeleteAdsByInventoryReference'][0])
    {
        $returnType = '\macropage\SDKs\ebay\rest\marketing\Model\BulkDeleteAdsByInventoryReferenceResponse';
        $request = $this->bulkDeleteAdsByInventoryReferenceRequest($campaignId, $bulkDeleteAdsByInventoryReferenceRequest, $contentType);
     ...
     * @return Request
     */
    public function bulkDeleteAdsByInventoryReferenceRequest($campaignId, $bulkDeleteAdsByInventoryReferenceRequest, string $contentType = self::contentTypes['bulkDeleteAdsByInventoryReference'][0])
    {
        ...
        if (isset($bulkDeleteAdsByInventoryReferenceRequest)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($bulkDeleteAdsByInventoryReferenceRequest));
            } else {
     ...
     * @param  BulkDeleteAdRequest $bulkDeleteAdRequest This request object defines the fields for the &lt;b&gt;bulkDeleteAdsByListingId&lt;/b&gt; request. (required)
     ...
     */
    public function bulkDeleteAdsByListingId($campaignId, $bulkDeleteAdRequest, string $contentType = self::contentTypes['bulkDeleteAdsByListingId'][0])
    {
        [$response] = $this->bulkDeleteAdsByListingIdWithHttpInfo($campaignId, $bulkDeleteAdRequest, $contentType);
        return $response;
    }
     ...
     */
    public function bulkDeleteAdsByListingIdWithHttpInfo($campaignId, $bulkDeleteAdRequest, string $contentType = self::contentTypes['bulkDeleteAdsByListingId'][0])
    {
        $request = $this->bulkDeleteAdsByListingIdRequest($campaignId, $bulkDeleteAdRequest, $contentType);
     ...
     * @return PromiseInterface
     */
    public function bulkDeleteAdsByListingIdAsync($campaignId, $bulkDeleteAdRequest, string $contentType = self::contentTypes['bulkDeleteAdsByListingId'][0])
    {
        return $this->bulkDeleteAdsByListingIdAsyncWithHttpInfo($campaignId, $bulkDeleteAdRequest, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return PromiseInterface
     */
    public function bulkDeleteAdsByListingIdAsyncWithHttpInfo($campaignId, $bulkDeleteAdRequest, string $contentType = self::contentTypes['bulkDeleteAdsByListingId'][0])
    {
        $returnType = '\macropage\SDKs\ebay\rest\marketing\Model\BulkDeleteAdResponse';
        $request = $this->bulkDeleteAdsByListingIdRequest($campaignId, $bulkDeleteAdRequest, $contentType);
     ...
     * @return Request
     */
    public function bulkDeleteAdsByListingIdRequest($campaignId, $bulkDeleteAdRequest, string $contentType = self::contentTypes['bulkDeleteAdsByListingId'][0])
    {
        ...
        if (isset($bulkDeleteAdRequest)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($bulkDeleteAdRequest));
            } else {
     ...
     * @param  BulkCreateAdsByInventoryReferenceRequest $bulkCreateAdsByInventoryReferenceRequest This request object defines the fields for the &lt;b&gt;BulkCreateAdsByInventoryReference&lt;/b&gt; request. (required)
     ...
     */
    public function bulkUpdateAdsBidByInventoryReference($campaignId, $bulkCreateAdsByInventoryReferenceRequest, string $contentType = self::contentTypes['bulkUpdateAdsBidByInventoryReference'][0])
    {
        [$response] = $this->bulkUpdateAdsBidByInventoryReferenceWithHttpInfo($campaignId, $bulkCreateAdsByInventoryReferenceRequest, $contentType);
        return $response;
    }
     ...
     */
    public function bulkUpdateAdsBidByInventoryReferenceWithHttpInfo($campaignId, $bulkCreateAdsByInventoryReferenceRequest, string $contentType = self::contentTypes['bulkUpdateAdsBidByInventoryReference'][0])
    {
        $request = $this->bulkUpdateAdsBidByInventoryReferenceRequest($campaignId, $bulkCreateAdsByInventoryReferenceRequest, $contentType);
     ...
     * @return PromiseInterface
     */
    public function bulkUpdateAdsBidByInventoryReferenceAsync($campaignId, $bulkCreateAdsByInventoryReferenceRequest, string $contentType = self::contentTypes['bulkUpdateAdsBidByInventoryReference'][0])
    {
        return $this->bulkUpdateAdsBidByInventoryReferenceAsyncWithHttpInfo($campaignId, $bulkCreateAdsByInventoryReferenceRequest, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return PromiseInterface
     */
    public function bulkUpdateAdsBidByInventoryReferenceAsyncWithHttpInfo($campaignId, $bulkCreateAdsByInventoryReferenceRequest, string $contentType = self::contentTypes['bulkUpdateAdsBidByInventoryReference'][0])
    {
        $returnType = '\macropage\SDKs\ebay\rest\marketing\Model\BulkUpdateAdsByInventoryReferenceResponse';
        $request = $this->bulkUpdateAdsBidByInventoryReferenceRequest($campaignId, $bulkCreateAdsByInventoryReferenceRequest, $contentType);
     ...
     * @return Request
     */
    public function bulkUpdateAdsBidByInventoryReferenceRequest($campaignId, $bulkCreateAdsByInventoryReferenceRequest, string $contentType = self::contentTypes['bulkUpdateAdsBidByInventoryReference'][0])
    {
     ...
     *
     * @param  string $campaignId This path parameter specifies the unique eBay-assigned identifier of the ad campaign for which to update the bid percentage for a set of ads.&lt;br&gt;&lt;br&gt; Use the &lt;a href&#x3D;\&quot;/api-docs/sell/marketing/resources/campaign/methods/getCampaigns\&quot; target&#x3D;\&quot;_blank\&quot;&gt;getCampaigns&lt;/a&gt; method to retrieve campaign IDs. (required)
     * @param  BulkCreateAdRequest $bulkCreateAdRequest This request object defines the fields for the &lt;b&gt;BulkCreateAdsByListingId&lt;/b&gt; request. (required)
     ...
     */
    public function bulkUpdateAdsBidByListingId($campaignId, $bulkCreateAdRequest, string $contentType = self::contentTypes['bulkUpdateAdsBidByListingId'][0])
    {
        [$response] = $this->bulkUpdateAdsBidByListingIdWithHttpInfo($campaignId, $bulkCreateAdRequest, $contentType);
        return $response;
    }
     ...
     */
    public function bulkUpdateAdsBidByListingIdWithHttpInfo($campaignId, $bulkCreateAdRequest, string $contentType = self::contentTypes['bulkUpdateAdsBidByListingId'][0])
    {
        $request = $this->bulkUpdateAdsBidByListingIdRequest($campaignId, $bulkCreateAdRequest, $contentType);
     ...
     * @return PromiseInterface
     */
    public function bulkUpdateAdsBidByListingIdAsync($campaignId, $bulkCreateAdRequest, string $contentType = self::contentTypes['bulkUpdateAdsBidByListingId'][0])
    {
        return $this->bulkUpdateAdsBidByListingIdAsyncWithHttpInfo($campaignId, $bulkCreateAdRequest, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return PromiseInterface
     */
    public function bulkUpdateAdsBidByListingIdAsyncWithHttpInfo($campaignId, $bulkCreateAdRequest, string $contentType = self::contentTypes['bulkUpdateAdsBidByListingId'][0])
    {
        $returnType = '\macropage\SDKs\ebay\rest\marketing\Model\BulkAdUpdateResponse';
        $request = $this->bulkUpdateAdsBidByListingIdRequest($campaignId, $bulkCreateAdRequest, $contentType);
     ...
     * @return Request
     */
    public function bulkUpdateAdsBidByListingIdRequest($campaignId, $bulkCreateAdRequest, string $contentType = self::contentTypes['bulkUpdateAdsBidByListingId'][0])
    {
     ...
     * @param  BulkUpdateAdStatusRequest $bulkUpdateAdStatusRequest The bulk request to update the ads. (required)
     ...
     */
    public function bulkUpdateAdsStatus($campaignId, $bulkUpdateAdStatusRequest, string $contentType = self::contentTypes['bulkUpdateAdsStatus'][0])
    {
        [$response] = $this->bulkUpdateAdsStatusWithHttpInfo($campaignId, $bulkUpdateAdStatusRequest, $contentType);
        return $response;
    }
     ...
     */
    public function bulkUpdateAdsStatusWithHttpInfo($campaignId, $bulkUpdateAdStatusRequest, string $contentType = self::contentTypes['bulkUpdateAdsStatus'][0])
    {
        $request = $this->bulkUpdateAdsStatusRequest($campaignId, $bulkUpdateAdStatusRequest, $contentType);
     ...
     * @return PromiseInterface
     */
    public function bulkUpdateAdsStatusAsync($campaignId, $bulkUpdateAdStatusRequest, string $contentType = self::contentTypes['bulkUpdateAdsStatus'][0])
    {
        return $this->bulkUpdateAdsStatusAsyncWithHttpInfo($campaignId, $bulkUpdateAdStatusRequest, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return PromiseInterface
     */
    public function bulkUpdateAdsStatusAsyncWithHttpInfo($campaignId, $bulkUpdateAdStatusRequest, string $contentType = self::contentTypes['bulkUpdateAdsStatus'][0])
    {
        $returnType = '\macropage\SDKs\ebay\rest\marketing\Model\BulkAdUpdateStatusResponse';
        $request = $this->bulkUpdateAdsStatusRequest($campaignId, $bulkUpdateAdStatusRequest, $contentType);
     ...
     * @return Request
     */
    public function bulkUpdateAdsStatusRequest($campaignId, $bulkUpdateAdStatusRequest, string $contentType = self::contentTypes['bulkUpdateAdsStatus'][0])
    {
        ...
        if (isset($bulkUpdateAdStatusRequest)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($bulkUpdateAdStatusRequest));
            } else {
     ...
     * @param BulkUpdateAdStatusByListingIdRequest $bulkUpdateAdStatusByListingIdRequest The bulk request to update ads. (required)
     ...
     */
    public function bulkUpdateAdsStatusByListingId($campaignId, $bulkUpdateAdStatusByListingIdRequest, string $contentType = self::contentTypes['bulkUpdateAdsStatusByListingId'][0]): BulkAdUpdateStatusByListingIdResponse
    {
        return $this->bulkUpdateAdsStatusByListingIdWithHttpInfo($campaignId, $bulkUpdateAdStatusByListingIdRequest, $contentType);
    }
     ...
     */
    public function bulkUpdateAdsStatusByListingIdWithHttpInfo($campaignId, $bulkUpdateAdStatusByListingIdRequest, string $contentType = self::contentTypes['bulkUpdateAdsStatusByListingId'][0]): BulkAdUpdateStatusByListingIdResponse
    {
        $request = $this->bulkUpdateAdsStatusByListingIdRequest($campaignId, $bulkUpdateAdStatusByListingIdRequest, $contentType);
        ...
        try {
            ...
            if ($statusCode == 200) {
                ...
                return ObjectSerializer::deserialize($content, '\macropage\SDKs\ebay\rest\marketing\Model\BulkAdUpdateStatusByListingIdResponse', []);
            }
     ...
     * @return PromiseInterface
     */
    public function bulkUpdateAdsStatusByListingIdAsync($campaignId, $bulkUpdateAdStatusByListingIdRequest, string $contentType = self::contentTypes['bulkUpdateAdsStatusByListingId'][0])
    {
        return $this->bulkUpdateAdsStatusByListingIdAsyncWithHttpInfo($campaignId, $bulkUpdateAdStatusByListingIdRequest, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return PromiseInterface
     */
    public function bulkUpdateAdsStatusByListingIdAsyncWithHttpInfo($campaignId, $bulkUpdateAdStatusByListingIdRequest, string $contentType = self::contentTypes['bulkUpdateAdsStatusByListingId'][0])
    {
        $returnType = '\macropage\SDKs\ebay\rest\marketing\Model\BulkAdUpdateStatusByListingIdResponse';
        $request = $this->bulkUpdateAdsStatusByListingIdRequest($campaignId, $bulkUpdateAdStatusByListingIdRequest, $contentType);
     ...
     * @return Request
     */
    public function bulkUpdateAdsStatusByListingIdRequest($campaignId, $bulkUpdateAdStatusByListingIdRequest, string $contentType = self::contentTypes['bulkUpdateAdsStatusByListingId'][0])
    {
        ...
        if (isset($bulkUpdateAdStatusByListingIdRequest)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($bulkUpdateAdStatusByListingIdRequest));
            } else {
     ...
     * @param  CreateAdRequest $createAdRequest This request object defines the fields used in the &lt;b&gt;createAdByListingId&lt;/b&gt; request. (required)
     ...
     * @return object
     */
    public function createAdByListingId($campaignId, $createAdRequest, string $contentType = self::contentTypes['createAdByListingId'][0])
    {
        [$response] = $this->createAdByListingIdWithHttpInfo($campaignId, $createAdRequest, $contentType);
        return $response;
    }
     ...
     */
    public function createAdByListingIdWithHttpInfo($campaignId, $createAdRequest, string $contentType = self::contentTypes['createAdByListingId'][0])
    {
        $request = $this->createAdByListingIdRequest($campaignId, $createAdRequest, $contentType);
     ...
     * @return PromiseInterface
     */
    public function createAdByListingIdAsync($campaignId, $createAdRequest, string $contentType = self::contentTypes['createAdByListingId'][0])
    {
        return $this->createAdByListingIdAsyncWithHttpInfo($campaignId, $createAdRequest, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return PromiseInterface
     */
    public function createAdByListingIdAsyncWithHttpInfo($campaignId, $createAdRequest, string $contentType = self::contentTypes['createAdByListingId'][0])
    {
        $returnType = 'object';
        $request = $this->createAdByListingIdRequest($campaignId, $createAdRequest, $contentType);
     ...
     * @return Request
     */
    public function createAdByListingIdRequest($campaignId, $createAdRequest, string $contentType = self::contentTypes['createAdByListingId'][0])
    {
        ...
        if (isset($createAdRequest)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($createAdRequest));
            } else {
     ...
     * @param  CreateAdsByInventoryReferenceRequest $createAdsByInventoryReferenceRequest This request object defines the fields used in the &lt;b&gt;createAdsByInventoryReference&lt;/b&gt; request. (required)
     ...
     * @return AdReferences
     */
    public function createAdsByInventoryReference($campaignId, $createAdsByInventoryReferenceRequest, string $contentType = self::contentTypes['createAdsByInventoryReference'][0])
    {
        [$response] = $this->createAdsByInventoryReferenceWithHttpInfo($campaignId, $createAdsByInventoryReferenceRequest, $contentType);
        return $response;
    }
     ...
     */
    public function createAdsByInventoryReferenceWithHttpInfo($campaignId, $createAdsByInventoryReferenceRequest, string $contentType = self::contentTypes['createAdsByInventoryReference'][0])
    {
        $request = $this->createAdsByInventoryReferenceRequest($campaignId, $createAdsByInventoryReferenceRequest, $contentType);
     ...
     * @return PromiseInterface
     */
    public function createAdsByInventoryReferenceAsync($campaignId, $createAdsByInventoryReferenceRequest, string $contentType = self::contentTypes['createAdsByInventoryReference'][0])
    {
        return $this->createAdsByInventoryReferenceAsyncWithHttpInfo($campaignId, $createAdsByInventoryReferenceRequest, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return PromiseInterface
     */
    public function createAdsByInventoryReferenceAsyncWithHttpInfo($campaignId, $createAdsByInventoryReferenceRequest, string $contentType = self::contentTypes['createAdsByInventoryReference'][0])
    {
        $returnType = '\macropage\SDKs\ebay\rest\marketing\Model\AdReferences';
        $request = $this->createAdsByInventoryReferenceRequest($campaignId, $createAdsByInventoryReferenceRequest, $contentType);
     ...
     * @return Request
     */
    public function createAdsByInventoryReferenceRequest($campaignId, $createAdsByInventoryReferenceRequest, string $contentType = self::contentTypes['createAdsByInventoryReference'][0])
    {
        ...
        if (isset($createAdsByInventoryReferenceRequest)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($createAdsByInventoryReferenceRequest));
            } else {
     ...
     * @return int
     */
    public function deleteAd($adId, $campaignId, string $contentType = self::contentTypes['deleteAd'][0]): int
    {
        return $this->deleteAdWithHttpInfo($adId, $campaignId, $contentType);
    }
     ...
     * @return int
     */
    public function deleteAdWithHttpInfo($adId, $campaignId, string $contentType = self::contentTypes['deleteAd'][0]): int
    {
     ...
     * @param  DeleteAdsByInventoryReferenceRequest $deleteAdsByInventoryReferenceRequest This request object defines the fields for the &lt;b&gt;deleteAdsByInventoryReference&lt;/b&gt; request. (required)
     ...
     * @return AdIds
     */
    public function deleteAdsByInventoryReference($campaignId, $deleteAdsByInventoryReferenceRequest, string $contentType = self::contentTypes['deleteAdsByInventoryReference'][0])
    {
        [$response] = $this->deleteAdsByInventoryReferenceWithHttpInfo($campaignId, $deleteAdsByInventoryReferenceRequest, $contentType);
        return $response;
    }
     ...
     */
    public function deleteAdsByInventoryReferenceWithHttpInfo($campaignId, $deleteAdsByInventoryReferenceRequest, string $contentType = self::contentTypes['deleteAdsByInventoryReference'][0])
    {
        $request = $this->deleteAdsByInventoryReferenceRequest($campaignId, $deleteAdsByInventoryReferenceRequest, $contentType);
     ...
     * @return PromiseInterface
     */
    public function deleteAdsByInventoryReferenceAsync($campaignId, $deleteAdsByInventoryReferenceRequest, string $contentType = self::contentTypes['deleteAdsByInventoryReference'][0])
    {
        return $this->deleteAdsByInventoryReferenceAsyncWithHttpInfo($campaignId, $deleteAdsByInventoryReferenceRequest, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return PromiseInterface
     */
    public function deleteAdsByInventoryReferenceAsyncWithHttpInfo($campaignId, $deleteAdsByInventoryReferenceRequest, string $contentType = self::contentTypes['deleteAdsByInventoryReference'][0])
    {
        $returnType = '\macropage\SDKs\ebay\rest\marketing\Model\AdIds';
        $request = $this->deleteAdsByInventoryReferenceRequest($campaignId, $deleteAdsByInventoryReferenceRequest, $contentType);
     ...
     * @return Request
     */
    public function deleteAdsByInventoryReferenceRequest($campaignId, $deleteAdsByInventoryReferenceRequest, string $contentType = self::contentTypes['deleteAdsByInventoryReference'][0])
    {
        ...
        if (isset($deleteAdsByInventoryReferenceRequest)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($deleteAdsByInventoryReferenceRequest));
            } else {
    ...
    {
        [$response] = $this->getAdWithHttpInfo($adId, $campaignId, $contentType);
        return $response;
    }
     ...
     * @param  string|null $adGroupIds A comma-separated list of ad group IDs. The results will be filtered to only include active ads for these ad groups.&lt;br&gt;&lt;br&gt;Use the &lt;a href&#x3D;\&quot;/api-docs/sell/marketing/resources/adgroup/methods/getAdGroups\&quot; target&#x3D;\&quot;_blank\&quot;&gt;getAdGroups&lt;/a&gt; method to retrieve the ad group ID for the ad group.&lt;br /&gt;&lt;br /&gt;&lt;span class&#x3D;\&quot;tablenote\&quot;&gt;&lt;b&gt;Note:&lt;/b&gt; This field only applies to the Cost Per Click (CPC) funding model; it does not apply to the Cost Per Sale (CPS) funding model.&lt;/span&gt; (optional)
     * @param  string|null $adStatus A comma-separated list of ad statuses. The results will be filtered to only include the given statuses of the ad. If none are provided, all ads are returned.&lt;br&gt;&lt;br&gt;See &lt;a href&#x3D;\&quot;/api-docs/sell/marketing/types/pls:AdStatusEnum\&quot; target&#x3D;\&quot;_blank\&quot;&gt;AdStatusEnum&lt;/a&gt; for supported values. (optional)
     * @param  string|null $limit Specifies the maximum number of ads to return on a page in the paginated response.&lt;br&gt;&lt;br&gt;&lt;b&gt;Default: &lt;/b&gt;10 &lt;br&gt;&lt;br&gt;&lt;b&gt;Maximum:&lt;/b&gt; 500 (optional)
     * @param  string|null $listingIds A comma-separated list of listing IDs. &lt;br&gt;&lt;br&gt;&lt;span class&#x3D;\&quot;tablenote\&quot;&gt;&lt;b&gt;Note:&lt;/b&gt; The response includes only active ads. The results do not include listing IDs that are excluded by other conditions.&lt;/span&gt; (optional)
     * @param  string|null $offset Specifies the number of ads to skip in the result set before returning the first ad in the paginated response.  &lt;p&gt;Combine &lt;b&gt;offset&lt;/b&gt; with the &lt;b&gt;limit&lt;/b&gt; query parameter to control the items returned in the response. For example, if you supply an &lt;b&gt;offset&lt;/b&gt; of &lt;code&gt;0&lt;/code&gt; and a &lt;b&gt;limit&lt;/b&gt; of &lt;code&gt;10&lt;/code&gt;, the first page of the response contains the first 10 items from the complete list of items retrieved by the call. If &lt;b&gt;offset&lt;/b&gt; is &lt;code&gt;10&lt;/code&gt; and &lt;b&gt;limit&lt;/b&gt; is &lt;code&gt;20&lt;/code&gt;, the first page of the response contains items 11-30 from the complete result set.&lt;/p&gt; &lt;p&gt;&lt;b&gt;Default:&lt;/b&gt; 0&lt;/p&gt; (optional)
    ...
    {
        [$response] = $this->getAdsWithHttpInfo($campaignId, $adGroupIds, $adStatus, $limit, $listingIds, $offset, $contentType);
        return $response;
    }
    ...
    {
        [$response] = $this->getAdsByInventoryReferenceWithHttpInfo($campaignId, $inventoryReferenceId, $inventoryReferenceType, $contentType);
        return $response;
    }
     ...
     * @param  UpdateBidPercentageRequest $updateBidPercentageRequest This type defines the fields for the &lt;b&gt;updateBid&lt;/b&gt; request. (required)
     ...
     * @return void
     */
    public function updateBid($adId, $campaignId, $updateBidPercentageRequest, string $contentType = self::contentTypes['updateBid'][0])
    {
        $this->updateBidWithHttpInfo($adId, $campaignId, $updateBidPercentageRequest, $contentType);
    }
     ...
     */
    public function updateBidWithHttpInfo($adId, $campaignId, $updateBidPercentageRequest, string $contentType = self::contentTypes['updateBid'][0])
    {
        $request = $this->updateBidRequest($adId, $campaignId, $updateBidPercentageRequest, $contentType);
     ...
     * @return PromiseInterface
     */
    public function updateBidAsync($adId, $campaignId, $updateBidPercentageRequest, string $contentType = self::contentTypes['updateBid'][0])
    {
        return $this->updateBidAsyncWithHttpInfo($adId, $campaignId, $updateBidPercentageRequest, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return PromiseInterface
     */
    public function updateBidAsyncWithHttpInfo($adId, $campaignId, $updateBidPercentageRequest, string $contentType = self::contentTypes['updateBid'][0])
    {
        $returnType = '';
        $request = $this->updateBidRequest($adId, $campaignId, $updateBidPercentageRequest, $contentType);
     ...
     * @return Request
     */
    public function updateBidRequest($adId, $campaignId, $updateBidPercentageRequest, string $contentType = self::contentTypes['updateBid'][0])
    {
        ...
        if (isset($updateBidPercentageRequest)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($updateBidPercentageRequest));
            } else {
