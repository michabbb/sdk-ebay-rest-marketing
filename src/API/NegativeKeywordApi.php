...
class NegativeKeywordApi
{
     ...
     */
    public function bulkCreateNegativeKeyword($contentType, $bulkCreateNegativeKeywordRequest, string $contentType = self::contentTypes['bulkCreateNegativeKeyword'][0])
    {
        list($response) = $this->bulkCreateNegativeKeywordWithHttpInfo($contentType, $bulkCreateNegativeKeywordRequest, $contentType);
        return $response;
    }
     ...
     */
    public function bulkCreateNegativeKeywordWithHttpInfo($contentType, $bulkCreateNegativeKeywordRequest, string $contentType = self::contentTypes['bulkCreateNegativeKeyword'][0])
    {
        $request = $this->bulkCreateNegativeKeywordRequest($contentType, $bulkCreateNegativeKeywordRequest, $contentType);
     ...
     */
    public function bulkCreateNegativeKeywordAsync($contentType, $bulkCreateNegativeKeywordRequest, string $contentType = self::contentTypes['bulkCreateNegativeKeyword'][0])
    {
        return $this->bulkCreateNegativeKeywordAsyncWithHttpInfo($contentType, $bulkCreateNegativeKeywordRequest, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function bulkCreateNegativeKeywordAsyncWithHttpInfo($contentType, $bulkCreateNegativeKeywordRequest, string $contentType = self::contentTypes['bulkCreateNegativeKeyword'][0])
    {
        $returnType = '\macropage\SDKs\ebay\rest\marketing\Model\BulkCreateNegativeKeywordResponse';
        $request = $this->bulkCreateNegativeKeywordRequest($contentType, $bulkCreateNegativeKeywordRequest, $contentType);
     ...
     */
    public function bulkCreateNegativeKeywordRequest($contentType, $bulkCreateNegativeKeywordRequest, string $contentType = self::contentTypes['bulkCreateNegativeKeyword'][0])
    {

        // verify the required parameter 'contentType' is set
        if ($contentType === null || (is_array($contentType) && count($contentType) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $contentType when calling bulkCreateNegativeKeyword'
            );
        }
     ...
     */
    public function bulkUpdateNegativeKeyword($contentType, $bulkUpdateNegativeKeywordRequest, string $contentType = self::contentTypes['bulkUpdateNegativeKeyword'][0])
    {
        list($response) = $this->bulkUpdateNegativeKeywordWithHttpInfo($contentType, $bulkUpdateNegativeKeywordRequest, $contentType);
        return $response;
    }
     ...
     */
    public function bulkUpdateNegativeKeywordWithHttpInfo($contentType, $bulkUpdateNegativeKeywordRequest, string $contentType = self::contentTypes['bulkUpdateNegativeKeyword'][0])
    {
        $request = $this->bulkUpdateNegativeKeywordRequest($contentType, $bulkUpdateNegativeKeywordRequest, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function bulkUpdateNegativeKeywordAsync($contentType, $bulkUpdateNegativeKeywordRequest, string $contentType = self::contentTypes['bulkUpdateNegativeKeyword'][0])
    {
        return $this->bulkUpdateNegativeKeywordAsyncWithHttpInfo($contentType, $bulkUpdateNegativeKeywordRequest, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function bulkUpdateNegativeKeywordAsyncWithHttpInfo($contentType, $bulkUpdateNegativeKeywordRequest, string $contentType = self::contentTypes['bulkUpdateNegativeKeyword'][0])
    {
        $returnType = '\macropage\SDKs\ebay\rest\marketing\Model\BulkUpdateNegativeKeywordResponse';
        $request = $this->bulkUpdateNegativeKeywordRequest($contentType, $bulkUpdateNegativeKeywordRequest, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function bulkUpdateNegativeKeywordRequest($contentType, $bulkUpdateNegativeKeywordRequest, string $contentType = self::contentTypes['bulkUpdateNegativeKeyword'][0])
    {

        // verify the required parameter 'contentType' is set
        if ($contentType === null || (is_array($contentType) && count($contentType) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $contentType when calling bulkUpdateNegativeKeyword'
            );
        }
     ...
     * @return object
     */
    public function createNegativeKeyword($contentType, $createNegativeKeywordRequest, string $contentType = self::contentTypes['createNegativeKeyword'][0])
    {
        list($response) = $this->createNegativeKeywordWithHttpInfo($contentType, $createNegativeKeywordRequest, $contentType);
        return $response;
    }
     ...
     */
    public function createNegativeKeywordWithHttpInfo($contentType, $createNegativeKeywordRequest, string $contentType = self::contentTypes['createNegativeKeyword'][0])
    {
        $request = $this->createNegativeKeywordRequest($contentType, $createNegativeKeywordRequest, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createNegativeKeywordAsync($contentType, $createNegativeKeywordRequest, string $contentType = self::contentTypes['createNegativeKeyword'][0])
    {
        return $this->createNegativeKeywordAsyncWithHttpInfo($contentType, $createNegativeKeywordRequest, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createNegativeKeywordAsyncWithHttpInfo($contentType, $createNegativeKeywordRequest, string $contentType = self::contentTypes['createNegativeKeyword'][0])
    {
        $returnType = 'object';
        $request = $this->createNegativeKeywordRequest($contentType, $createNegativeKeywordRequest, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function createNegativeKeywordRequest($contentType, $createNegativeKeywordRequest, string $contentType = self::contentTypes['createNegativeKeyword'][0])
    {

        // verify the required parameter 'contentType' is set
        if ($contentType === null || (is_array($contentType) && count($contentType) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $contentType when calling createNegativeKeyword'
            );
        }
     ...
     * @param  string $campaignIds This path parameter specifies the unique eBay-assigned identifier of the ad campaign associated with the negative keywords being retrieved.&lt;br /&gt;&lt;br /&gt;This query parameter is used if the seller wants to retrieve the negative keywords from a specific campaign. The results might not include these campaign IDs if other search conditions exclude them.&lt;br /&gt;&lt;br /&gt;&lt;span class&#x3D;\&quot;tablenote\&quot;&gt;&lt;b&gt;Note:&lt;/b&gt; Currently, only one campaign ID value is supported for each request.&lt;/span&gt;&lt;br&gt;&lt;br&gt; Use the &lt;a href&#x3D;\&quot;/api-docs/sell/marketing/resources/campaign/methods/getCampaigns\&quot; target&#x3D;\&quot;_blank\&quot;&gt;getCampaigns&lt;/a&gt; method to retrieve campaign IDs. (optional)
     * @param  string $limit The number of results, from the current result set, to be returned in a single page. (optional)
     * @param  string $negativeKeywordStatus A comma-separated list of negative keyword statuses.&lt;br /&gt;&lt;br /&gt;This query parameter is used if the seller wants to filter the search results based on one or more negative keyword statuses.&lt;br&gt;&lt;br&gt; See &lt;a href&#x3D;\&quot;/api-docs/sell/marketing/types/pls:NegativeKeywordStatusEnum\&quot; target&#x3D;\&quot;_blank\&quot;&gt;NegativeKeywordStatusEnum&lt;/a&gt; for supported values. (optional)
     ...
     * @return void
     */
    public function updateNegativeKeyword($negativeKeywordId, $contentType, $updateNegativeKeywordRequest, string $contentType = self::contentTypes['updateNegativeKeyword'][0])
    {
        $this->updateNegativeKeywordWithHttpInfo($negativeKeywordId, $contentType, $updateNegativeKeywordRequest, $contentType);
    }
     ...
     */
    public function updateNegativeKeywordWithHttpInfo($negativeKeywordId, $contentType, $updateNegativeKeywordRequest, string $contentType = self::contentTypes['updateNegativeKeyword'][0])
    {
        $request = $this->updateNegativeKeywordRequest($negativeKeywordId, $contentType, $updateNegativeKeywordRequest, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateNegativeKeywordAsync($negativeKeywordId, $contentType, $updateNegativeKeywordRequest, string $contentType = self::contentTypes['updateNegativeKeyword'][0])
    {
        return $this->updateNegativeKeywordAsyncWithHttpInfo($negativeKeywordId, $contentType, $updateNegativeKeywordRequest, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateNegativeKeywordAsyncWithHttpInfo($negativeKeywordId, $contentType, $updateNegativeKeywordRequest, string $contentType = self::contentTypes['updateNegativeKeyword'][0])
    {
        $returnType = '';
        $request = $this->updateNegativeKeywordRequest($negativeKeywordId, $contentType, $updateNegativeKeywordRequest, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateNegativeKeywordRequest($negativeKeywordId, $contentType, $updateNegativeKeywordRequest, string $contentType = self::contentTypes['updateNegativeKeyword'][0])
    {
        ...
        if ($contentType === null || (is_array($contentType) && count($contentType) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $contentType when calling updateNegativeKeyword'
            );
        }
