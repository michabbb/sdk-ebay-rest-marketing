...
class AdReportTaskApi
{
     ...
     * @return void
     */
    public function createReportTask($contentType, $createReportTask, string $contentType = self::contentTypes['createReportTask'][0])
    {
        $this->createReportTaskWithHttpInfo($contentType, $createReportTask, $contentType);
    }
     ...
     */
    public function createReportTaskWithHttpInfo($contentType, $createReportTask, string $contentType = self::contentTypes['createReportTask'][0])
    {
        $request = $this->createReportTaskRequest($contentType, $createReportTask, $contentType);
     ...
     */
    public function createReportTaskAsync($contentType, $createReportTask, string $contentType = self::contentTypes['createReportTask'][0])
    {
        return $this->createReportTaskAsyncWithHttpInfo($contentType, $createReportTask, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createReportTaskAsyncWithHttpInfo($contentType, $createReportTask, string $contentType = self::contentTypes['createReportTask'][0])
    {
        $returnType = '';
        $request = $this->createReportTaskRequest($contentType, $createReportTask, $contentType);
     ...
     */
    public function createReportTaskRequest($contentType, $createReportTask, string $contentType = self::contentTypes['createReportTask'][0])
    {

        // verify the required parameter 'contentType' is set
        if ($contentType === null || (is_array($contentType) && count($contentType) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $contentType when calling createReportTask'
            );
        }
     ...
     *
     * @param  string $limit Specifies the maximum number of report tasks to return on a page in the paginated response.&lt;br&gt;&lt;br&gt;&lt;b&gt;Default:&lt;/b&gt; 10&lt;br&gt;&lt;b&gt;Maximum:&lt;/b&gt; 500 (optional)
     ...
     * @param  string $reportTaskStatuses This query parameter filters the returned report tasks by their status. Supply a comma-separated list of the report statuses you want returned. The results are filtered to include only the report statuses you specify.&lt;br /&gt;&lt;br /&gt;&lt;span class&#x3D;\&quot;tablenote\&quot;&gt;&lt;span style&#x3D;\&quot;color:#004680\&quot;&gt;&lt;strong&gt;Note:&lt;/strong&gt;&lt;/span&gt; The results might not include some report tasks if other search conditions exclude them.&lt;/span&gt;&lt;br /&gt;See &lt;a href&#x3D;\&quot;/api-docs/sell/marketing/types/plr:TaskStatusEnum\&quot; target&#x3D;\&quot;_blank\&quot;&gt;TaskStatusEnum&lt;/a&gt; for supported values. (optional)
