...
use macropage\SDKs\ebay\rest\marketing\Model\CreateCampaignRequest;
...
class CampaignApi
{
     ...
     * @return object
     */
    public function cloneCampaign($campaignId, $cloneCampaignRequest, string $contentType = self::contentTypes['cloneCampaign'][0])
    {
        [$response] = $this->cloneCampaignWithHttpInfo($campaignId, $cloneCampaignRequest, $contentType);
        return $response;
    }
     ...
     */
    public function cloneCampaignWithHttpInfo($campaignId, $cloneCampaignRequest, string $contentType = self::contentTypes['cloneCampaign'][0])
    {
        $request = $this->cloneCampaignRequest($campaignId, $cloneCampaignRequest, $contentType);
     ...
     */
    public function cloneCampaignAsync($campaignId, $cloneCampaignRequest, string $contentType = self::contentTypes['cloneCampaign'][0])
    {
        return $this->cloneCampaignAsyncWithHttpInfo($campaignId, $cloneCampaignRequest, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function cloneCampaignAsyncWithHttpInfo($campaignId, $cloneCampaignRequest, string $contentType = self::contentTypes['cloneCampaign'][0])
    {
        $returnType = 'object';
        $request = $this->cloneCampaignRequest($campaignId, $cloneCampaignRequest, $contentType);
     ...
     */
    public function cloneCampaignRequest($campaignId, $cloneCampaignRequest, string $contentType = self::contentTypes['cloneCampaign'][0])
    {
     ...
     *
     * @param CreateCampaignRequest $createCampaignRequest This type defines the fields for the create campaign request. (required)
     ...
     */
    public function createCampaign(CreateCampaignRequest $createCampaignRequest, string $contentType = self::contentTypes['createCampaign'][0])
    {
        return $this->createCampaignWithHttpInfo($createCampaignRequest, $contentType);
    }
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createCampaign'] to see the possible values for this operation
     *
     * @return string|null campaignID
     * @throws InvalidArgumentException
     * @throws ApiException|GuzzleException on non-2xx response or if the response body is not in the expected format
     */
    public function createCampaignWithHttpInfo(CreateCampaignRequest $createCampaignRequest, string $contentType = self::contentTypes['createCampaign'][0]): ?string
    {
        $request = $this->createCampaignRequest($createCampaignRequest, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createCampaignAsync($createCampaignRequest, string $contentType = self::contentTypes['createCampaign'][0])
    {
        return $this->createCampaignAsyncWithHttpInfo($createCampaignRequest, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createCampaignAsyncWithHttpInfo($createCampaignRequest, string $contentType = self::contentTypes['createCampaign'][0])
    {
        $returnType = 'object';
        $request = $this->createCampaignRequest($createCampaignRequest, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function createCampaignRequest($createCampaignRequest, string $contentType = self::contentTypes['createCampaign'][0])
    {
     ...
     *
     * @param  string|null $inventoryReferenceId This query parameter specifies the unique identifier of a single-item listing or a multi-variation listing associated with the campaign being retrieved.&lt;br&gt;&lt;br&gt;To retrieve an campaign for a single-item listing, set the &lt;b&gt;inventoryReferenceType&lt;/b&gt; value to &lt;code&gt;INVENTORY_ITEM&lt;/code&gt; and specify an item ID or a SKU (if the SKU is defined in the listing).&lt;br&gt;&lt;br&gt;To retrieve an campaign for a multi-variation listing, set the &lt;b&gt;inventoryReferenceType&lt;/b&gt; value to &lt;code&gt;INVENTORY_ITEM_GROUP&lt;/code&gt; and specify the item ID for the multi-variation listing or the &lt;b&gt;inventoryitemGroupKey&lt;/b&gt; value as defined in the Inventory API.&lt;br&gt;&lt;br&gt;&lt;span class&#x3D;\&quot;tablenote\&quot;&gt;&lt;b&gt;Note:&lt;/b&gt; You must always pass in both &lt;b&gt;inventory_reference_id&lt;/b&gt; and &lt;b&gt;inventory_reference_type&lt;/b&gt;.&lt;/span&gt; (optional)
     * @param  string|null $inventoryReferenceType This query parameter specifies the type of the seller&#39;s inventory reference ID, which is a listing or group of items.&lt;br&gt;&lt;br&gt;See &lt;a href&#x3D;\&quot;/api-docs/sell/marketing/types/pls:InventoryReferenceTypeEnum\&quot; target&#x3D;\&quot;_blank\&quot;&gt;InventoryReferenceTypeEnum&lt;/a&gt; for supported values.&lt;br&gt;&lt;br&gt;&lt;span class&#x3D;\&quot;tablenote\&quot;&gt;&lt;b&gt;Note:&lt;/b&gt; You must always pass in both &lt;b&gt;inventory_reference_id&lt;/b&gt; and &lt;b&gt;inventory_reference_type&lt;/b&gt;.&lt;/span&gt; (optional)
     * @param  string|null $listingId This query parameter specifies the unique identifier of the eBay listing associated with the ad being used to retrieve the campaign.&lt;br /&gt;&lt;br /&gt;eBay &lt;i&gt;listing IDs&lt;/i&gt; are generated by either the &lt;a href&#x3D;\&quot;/Devzone/XML/docs/Reference/eBay/index.html\&quot; title&#x3D;\&quot;Trading API Reference\&quot;&gt;Trading API&lt;/a&gt; or the &lt;a href&#x3D;\&quot;/api-docs/sell/inventory/resources/methods\&quot;&gt;Inventory API&lt;/a&gt; when you create a listing. (optional)
    ...
    {
        [$response] = $this->findCampaignByAdReferenceWithHttpInfo($inventoryReferenceId, $inventoryReferenceType, $listingId, $contentType);
        return $response;
    }
    ...
    {
        [$response] = $this->getCampaignWithHttpInfo($campaignId, $contentType);
        return $response;
    }
    ...
    {
        [$response] = $this->getCampaignByNameWithHttpInfo($campaignName, $contentType);
        return $response;
    }
     ...
     */
    public function getCampaigns($campaignName = null, $campaignStatus = null, $campaignTargetingTypes = null, $channels = null, $endDateRange = null, $fundingStrategy = null, $limit = null, $offset = null, $startDateRange = null, string $contentType = self::contentTypes['getCampaigns'][0])
    {
        [$response] = $this->getCampaignsWithHttpInfo($campaignName, $campaignStatus, $campaignTargetingTypes, $channels, $endDateRange, $fundingStrategy, $limit, $offset, $startDateRange, $contentType);
        return $response;
    }
     ...
     */
    public function getCampaignsWithHttpInfo($campaignName = null, $campaignStatus = null, $campaignTargetingTypes = null, $channels = null, $endDateRange = null, $fundingStrategy = null, $limit = null, $offset = null, $startDateRange = null, string $contentType = self::contentTypes['getCampaigns'][0])
    {
        $request = $this->getCampaignsRequest($campaignName, $campaignStatus, $campaignTargetingTypes, $channels, $endDateRange, $fundingStrategy, $limit, $offset, $startDateRange, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCampaignsAsync($campaignName = null, $campaignStatus = null, $campaignTargetingTypes = null, $channels = null, $endDateRange = null, $fundingStrategy = null, $limit = null, $offset = null, $startDateRange = null, string $contentType = self::contentTypes['getCampaigns'][0])
    {
        return $this->getCampaignsAsyncWithHttpInfo($campaignName, $campaignStatus, $campaignTargetingTypes, $channels, $endDateRange, $fundingStrategy, $limit, $offset, $startDateRange, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCampaignsAsyncWithHttpInfo($campaignName = null, $campaignStatus = null, $campaignTargetingTypes = null, $channels = null, $endDateRange = null, $fundingStrategy = null, $limit = null, $offset = null, $startDateRange = null, string $contentType = self::contentTypes['getCampaigns'][0])
    {
        $returnType = '\macropage\SDKs\ebay\rest\marketing\Model\CampaignPagedCollectionResponse';
        $request = $this->getCampaignsRequest($campaignName, $campaignStatus, $campaignTargetingTypes, $channels, $endDateRange, $fundingStrategy, $limit, $offset, $startDateRange, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCampaignsRequest($campaignName = null, $campaignStatus = null, $campaignTargetingTypes = null, $channels = null, $endDateRange = null, $fundingStrategy = null, $limit = null, $offset = null, $startDateRange = null, string $contentType = self::contentTypes['getCampaigns'][0])
    {
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            ...
            'campaign_targeting_types', // param base name
            'string', // openApiType
            'form', // style
            true, // explode
            false // required
     ...
     *
     * @param  \macropage\SDKs\ebay\rest\marketing\Model\QuickSetupRequest $quickSetupRequest This type defines the fields to create a quick setup priority strategy campaign. (required)
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     */
    public function setupQuickCampaign($quickSetupRequest, string $contentType = self::contentTypes['setupQuickCampaign'][0])
    {
        [$response] = $this->setupQuickCampaignWithHttpInfo($quickSetupRequest, $contentType);
        return $response;
    }
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     */
    public function setupQuickCampaignWithHttpInfo($quickSetupRequest, string $contentType = self::contentTypes['setupQuickCampaign'][0])
    {
        $request = $this->setupQuickCampaignRequest($quickSetupRequest, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function setupQuickCampaignAsync($quickSetupRequest, string $contentType = self::contentTypes['setupQuickCampaign'][0])
    {
        return $this->setupQuickCampaignAsyncWithHttpInfo($quickSetupRequest, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function setupQuickCampaignAsyncWithHttpInfo($quickSetupRequest, string $contentType = self::contentTypes['setupQuickCampaign'][0])
    {
        $returnType = 'object';
        $request = $this->setupQuickCampaignRequest($quickSetupRequest, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function setupQuickCampaignRequest($quickSetupRequest, string $contentType = self::contentTypes['setupQuickCampaign'][0])
    {
    ...
    {
        [$response] = $this->suggestBudgetWithHttpInfo($xEBAYCMARKETPLACEID, $contentType);
        return $response;
    }
     ...
     * @param  string|null $categoryIds Specifies the category ID that is used to limit the results. This refers to an exact leaf category (the lowest level in that category and has no children). This field can have one category ID, or a comma-separated list of IDs. To return all category IDs, set to &lt;code&gt;null&lt;/code&gt;.&lt;br&gt;&lt;br&gt;Use the &lt;a href&#x3D;\&quot;/api-docs/commerce/taxonomy/resources/category_tree/methods/getCategorySuggestions\&quot; target&#x3D;\&quot;_blank\&quot;&gt;getCategorySuggestions&lt;/a&gt; method to retrieve category IDs.&lt;br /&gt;&lt;br /&gt;&lt;b&gt;Maximum: &lt;/b&gt; 10 (optional)
     * @param  string|null $limit Specifies the maximum number of campaigns to return on a page in the paginated response. If no value is specified, the default value is used. &lt;br /&gt;&lt;br /&gt;&lt;b&gt;Default: &lt;/b&gt;10 &lt;br /&gt;&lt;br /&gt;&lt;b&gt;Minimum: &lt;/b&gt; 1&lt;br /&gt;&lt;br /&gt;&lt;b&gt;Maximum: &lt;/b&gt; 1000 (optional)
     * @param  string|null $offset Specifies the number of campaigns to skip in the result set before returning the first report in the paginated response.&lt;br&gt;&lt;br&gt;Combine &lt;b&gt;offset&lt;/b&gt; with the &lt;b&gt;limit&lt;/b&gt; query parameter to control the items returned in the response. For example, if you supply an &lt;b&gt;offset&lt;/b&gt; of &lt;code&gt;0&lt;/code&gt; and a &lt;b&gt;limit&lt;/b&gt; of &lt;code&gt;10&lt;/code&gt;, the first page of the response contains the first 10 items from the complete list of items retrieved by the call. If &lt;b&gt;offset&lt;/b&gt; is &lt;code&gt;10&lt;/code&gt; and &lt;b&gt;limit&lt;/b&gt; is &lt;code&gt;20&lt;/code&gt;, the first page of the response contains items 11-30 from the complete result set.&lt;br&gt;&lt;br&gt; &lt;b&gt;Default:&lt;/b&gt; 0 (optional)
    ...
    {
        [$response] = $this->suggestItemsWithHttpInfo($campaignId, $categoryIds, $limit, $offset, $contentType);
        return $response;
    }
     ...
     *
     * @param  \macropage\SDKs\ebay\rest\marketing\Model\SuggestMaxCpcRequest $suggestMaxCpcRequest This type defines the fields used in the &lt;b&gt;suggestMaxCpc&lt;/b&gt; request. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['suggestMaxCpc'] to see the possible values for this operation
     *
     * @return \macropage\SDKs\ebay\rest\marketing\Model\SuggestMaxCpcResponse
     *@throws InvalidArgumentException
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     */
    public function suggestMaxCpc($suggestMaxCpcRequest, string $contentType = self::contentTypes['suggestMaxCpc'][0])
    {
        [$response] = $this->suggestMaxCpcWithHttpInfo($suggestMaxCpcRequest, $contentType);
        return $response;
    }

    /**
     * Operation suggestMaxCpcWithHttpInfo
     *
     * @param  \macropage\SDKs\ebay\rest\marketing\Model\SuggestMaxCpcRequest $suggestMaxCpcRequest This type defines the fields used in the &lt;b&gt;suggestMaxCpc&lt;/b&gt; request. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['suggestMaxCpc'] to see the possible values for this operation
     *
     * @return array of \macropage\SDKs\ebay\rest\marketing\Model\SuggestMaxCpcResponse, HTTP status code, HTTP response headers (array of strings)
     *@throws InvalidArgumentException
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     */
    public function suggestMaxCpcWithHttpInfo($suggestMaxCpcRequest, string $contentType = self::contentTypes['suggestMaxCpc'][0])
    {
        $request = $this->suggestMaxCpcRequest($suggestMaxCpcRequest, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\macropage\SDKs\ebay\rest\marketing\Model\SuggestMaxCpcResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\macropage\SDKs\ebay\rest\marketing\Model\SuggestMaxCpcResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\macropage\SDKs\ebay\rest\marketing\Model\SuggestMaxCpcResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\macropage\SDKs\ebay\rest\marketing\Model\SuggestMaxCpcResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\macropage\SDKs\ebay\rest\marketing\Model\SuggestMaxCpcResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function suggestMaxCpcAsync($suggestMaxCpcRequest, string $contentType = self::contentTypes['suggestMaxCpc'][0])
    {
        return $this->suggestMaxCpcAsyncWithHttpInfo($suggestMaxCpcRequest, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation suggestMaxCpcAsyncWithHttpInfo
     *
     * @param  \macropage\SDKs\ebay\rest\marketing\Model\SuggestMaxCpcRequest $suggestMaxCpcRequest This type defines the fields used in the &lt;b&gt;suggestMaxCpc&lt;/b&gt; request. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['suggestMaxCpc'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function suggestMaxCpcAsyncWithHttpInfo($suggestMaxCpcRequest, string $contentType = self::contentTypes['suggestMaxCpc'][0])
    {
        $returnType = '\macropage\SDKs\ebay\rest\marketing\Model\SuggestMaxCpcResponse';
        $request = $this->suggestMaxCpcRequest($suggestMaxCpcRequest, $contentType);
    ...
    /**
     * Create request for operation 'suggestMaxCpc'
     *
     * @param  \macropage\SDKs\ebay\rest\marketing\Model\SuggestMaxCpcRequest $suggestMaxCpcRequest This type defines the fields used in the &lt;b&gt;suggestMaxCpc&lt;/b&gt; request. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['suggestMaxCpc'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function suggestMaxCpcRequest($suggestMaxCpcRequest, string $contentType = self::contentTypes['suggestMaxCpc'][0])
    {

        // verify the required parameter 'suggestMaxCpcRequest' is set
        if ($suggestMaxCpcRequest === null || (is_array($suggestMaxCpcRequest) && count($suggestMaxCpcRequest) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $suggestMaxCpcRequest when calling suggestMaxCpc'
            );
        }


        $resourcePath = '/ad_campaign/suggest_max_cpc';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($suggestMaxCpcRequest)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($suggestMaxCpcRequest));
            } else {
                $httpBody = $suggestMaxCpcRequest;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
     ...
     * @return void
     */
    public function updateAdRateStrategy($campaignId, $updateAdrateStrategyRequest, string $contentType = self::contentTypes['updateAdRateStrategy'][0])
    {
        $this->updateAdRateStrategyWithHttpInfo($campaignId, $updateAdrateStrategyRequest, $contentType);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateAdRateStrategyWithHttpInfo($campaignId, $updateAdrateStrategyRequest, string $contentType = self::contentTypes['updateAdRateStrategy'][0])
    {
        $request = $this->updateAdRateStrategyRequest($campaignId, $updateAdrateStrategyRequest, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateAdRateStrategyAsync($campaignId, $updateAdrateStrategyRequest, string $contentType = self::contentTypes['updateAdRateStrategy'][0])
    {
        return $this->updateAdRateStrategyAsyncWithHttpInfo($campaignId, $updateAdrateStrategyRequest, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateAdRateStrategyAsyncWithHttpInfo($campaignId, $updateAdrateStrategyRequest, string $contentType = self::contentTypes['updateAdRateStrategy'][0])
    {
        $returnType = '';
        $request = $this->updateAdRateStrategyRequest($campaignId, $updateAdrateStrategyRequest, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateAdRateStrategyRequest($campaignId, $updateAdrateStrategyRequest, string $contentType = self::contentTypes['updateAdRateStrategy'][0])
    {
     ...
     * @return void
     */
    public function updateBiddingStrategy($campaignId, $updateBiddingStrategyRequest, string $contentType = self::contentTypes['updateBiddingStrategy'][0])
    {
        $this->updateBiddingStrategyWithHttpInfo($campaignId, $updateBiddingStrategyRequest, $contentType);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateBiddingStrategyWithHttpInfo($campaignId, $updateBiddingStrategyRequest, string $contentType = self::contentTypes['updateBiddingStrategy'][0])
    {
        $request = $this->updateBiddingStrategyRequest($campaignId, $updateBiddingStrategyRequest, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateBiddingStrategyAsync($campaignId, $updateBiddingStrategyRequest, string $contentType = self::contentTypes['updateBiddingStrategy'][0])
    {
        return $this->updateBiddingStrategyAsyncWithHttpInfo($campaignId, $updateBiddingStrategyRequest, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateBiddingStrategyAsyncWithHttpInfo($campaignId, $updateBiddingStrategyRequest, string $contentType = self::contentTypes['updateBiddingStrategy'][0])
    {
        $returnType = '';
        $request = $this->updateBiddingStrategyRequest($campaignId, $updateBiddingStrategyRequest, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateBiddingStrategyRequest($campaignId, $updateBiddingStrategyRequest, string $contentType = self::contentTypes['updateBiddingStrategy'][0])
    {
     ...
     * @return void
     */
    public function updateCampaignBudget($campaignId, $updateCampaignBudgetRequest, string $contentType = self::contentTypes['updateCampaignBudget'][0])
    {
        $this->updateCampaignBudgetWithHttpInfo($campaignId, $updateCampaignBudgetRequest, $contentType);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateCampaignBudgetWithHttpInfo($campaignId, $updateCampaignBudgetRequest, string $contentType = self::contentTypes['updateCampaignBudget'][0])
    {
        $request = $this->updateCampaignBudgetRequest($campaignId, $updateCampaignBudgetRequest, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateCampaignBudgetAsync($campaignId, $updateCampaignBudgetRequest, string $contentType = self::contentTypes['updateCampaignBudget'][0])
    {
        return $this->updateCampaignBudgetAsyncWithHttpInfo($campaignId, $updateCampaignBudgetRequest, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateCampaignBudgetAsyncWithHttpInfo($campaignId, $updateCampaignBudgetRequest, string $contentType = self::contentTypes['updateCampaignBudget'][0])
    {
        $returnType = '';
        $request = $this->updateCampaignBudgetRequest($campaignId, $updateCampaignBudgetRequest, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateCampaignBudgetRequest($campaignId, $updateCampaignBudgetRequest, string $contentType = self::contentTypes['updateCampaignBudget'][0])
    {
     ...
     * @return void
     */
    public function updateCampaignIdentification($campaignId, $updateCampaignIdentificationRequest, string $contentType = self::contentTypes['updateCampaignIdentification'][0])
    {
        $this->updateCampaignIdentificationWithHttpInfo($campaignId, $updateCampaignIdentificationRequest, $contentType);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateCampaignIdentificationWithHttpInfo($campaignId, $updateCampaignIdentificationRequest, string $contentType = self::contentTypes['updateCampaignIdentification'][0])
    {
        $request = $this->updateCampaignIdentificationRequest($campaignId, $updateCampaignIdentificationRequest, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateCampaignIdentificationAsync($campaignId, $updateCampaignIdentificationRequest, string $contentType = self::contentTypes['updateCampaignIdentification'][0])
    {
        return $this->updateCampaignIdentificationAsyncWithHttpInfo($campaignId, $updateCampaignIdentificationRequest, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateCampaignIdentificationAsyncWithHttpInfo($campaignId, $updateCampaignIdentificationRequest, string $contentType = self::contentTypes['updateCampaignIdentification'][0])
    {
        $returnType = '';
        $request = $this->updateCampaignIdentificationRequest($campaignId, $updateCampaignIdentificationRequest, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateCampaignIdentificationRequest($campaignId, $updateCampaignIdentificationRequest, string $contentType = self::contentTypes['updateCampaignIdentification'][0])
    {
