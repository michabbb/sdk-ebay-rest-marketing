...
class KeywordApi
{
     ...
     */
    public function bulkCreateKeyword($campaignId, $contentType, $bulkCreateKeywordRequest, string $contentType = self::contentTypes['bulkCreateKeyword'][0])
    {
        list($response) = $this->bulkCreateKeywordWithHttpInfo($campaignId, $contentType, $bulkCreateKeywordRequest, $contentType);
        return $response;
    }
     ...
     */
    public function bulkCreateKeywordWithHttpInfo($campaignId, $contentType, $bulkCreateKeywordRequest, string $contentType = self::contentTypes['bulkCreateKeyword'][0])
    {
        $request = $this->bulkCreateKeywordRequest($campaignId, $contentType, $bulkCreateKeywordRequest, $contentType);
     ...
     */
    public function bulkCreateKeywordAsync($campaignId, $contentType, $bulkCreateKeywordRequest, string $contentType = self::contentTypes['bulkCreateKeyword'][0])
    {
        return $this->bulkCreateKeywordAsyncWithHttpInfo($campaignId, $contentType, $bulkCreateKeywordRequest, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function bulkCreateKeywordAsyncWithHttpInfo($campaignId, $contentType, $bulkCreateKeywordRequest, string $contentType = self::contentTypes['bulkCreateKeyword'][0])
    {
        $returnType = '\macropage\SDKs\ebay\rest\marketing\Model\BulkCreateKeywordResponse';
        $request = $this->bulkCreateKeywordRequest($campaignId, $contentType, $bulkCreateKeywordRequest, $contentType);
     ...
     */
    public function bulkCreateKeywordRequest($campaignId, $contentType, $bulkCreateKeywordRequest, string $contentType = self::contentTypes['bulkCreateKeyword'][0])
    {
        ...
        if ($contentType === null || (is_array($contentType) && count($contentType) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $contentType when calling bulkCreateKeyword'
            );
        }
     ...
     */
    public function bulkUpdateKeyword($campaignId, $contentType, $bulkUpdateKeywordRequest, string $contentType = self::contentTypes['bulkUpdateKeyword'][0])
    {
        list($response) = $this->bulkUpdateKeywordWithHttpInfo($campaignId, $contentType, $bulkUpdateKeywordRequest, $contentType);
        return $response;
    }
     ...
     */
    public function bulkUpdateKeywordWithHttpInfo($campaignId, $contentType, $bulkUpdateKeywordRequest, string $contentType = self::contentTypes['bulkUpdateKeyword'][0])
    {
        $request = $this->bulkUpdateKeywordRequest($campaignId, $contentType, $bulkUpdateKeywordRequest, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function bulkUpdateKeywordAsync($campaignId, $contentType, $bulkUpdateKeywordRequest, string $contentType = self::contentTypes['bulkUpdateKeyword'][0])
    {
        return $this->bulkUpdateKeywordAsyncWithHttpInfo($campaignId, $contentType, $bulkUpdateKeywordRequest, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function bulkUpdateKeywordAsyncWithHttpInfo($campaignId, $contentType, $bulkUpdateKeywordRequest, string $contentType = self::contentTypes['bulkUpdateKeyword'][0])
    {
        $returnType = '\macropage\SDKs\ebay\rest\marketing\Model\BulkUpdateKeywordResponse';
        $request = $this->bulkUpdateKeywordRequest($campaignId, $contentType, $bulkUpdateKeywordRequest, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function bulkUpdateKeywordRequest($campaignId, $contentType, $bulkUpdateKeywordRequest, string $contentType = self::contentTypes['bulkUpdateKeyword'][0])
    {
        ...
        if ($contentType === null || (is_array($contentType) && count($contentType) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $contentType when calling bulkUpdateKeyword'
            );
        }
     ...
     * @return object
     */
    public function createKeyword($campaignId, $contentType, $createKeywordRequest, string $contentType = self::contentTypes['createKeyword'][0])
    {
        list($response) = $this->createKeywordWithHttpInfo($campaignId, $contentType, $createKeywordRequest, $contentType);
        return $response;
    }
     ...
     */
    public function createKeywordWithHttpInfo($campaignId, $contentType, $createKeywordRequest, string $contentType = self::contentTypes['createKeyword'][0])
    {
        $request = $this->createKeywordRequest($campaignId, $contentType, $createKeywordRequest, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createKeywordAsync($campaignId, $contentType, $createKeywordRequest, string $contentType = self::contentTypes['createKeyword'][0])
    {
        return $this->createKeywordAsyncWithHttpInfo($campaignId, $contentType, $createKeywordRequest, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createKeywordAsyncWithHttpInfo($campaignId, $contentType, $createKeywordRequest, string $contentType = self::contentTypes['createKeyword'][0])
    {
        $returnType = 'object';
        $request = $this->createKeywordRequest($campaignId, $contentType, $createKeywordRequest, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function createKeywordRequest($campaignId, $contentType, $createKeywordRequest, string $contentType = self::contentTypes['createKeyword'][0])
    {
        ...
        if ($contentType === null || (is_array($contentType) && count($contentType) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $contentType when calling createKeyword'
            );
        }
     ...
     */
    public function updateKeyword($campaignId, $keywordId, $contentType, $updateKeywordRequest, string $contentType = self::contentTypes['updateKeyword'][0])
    {
        list($response) = $this->updateKeywordWithHttpInfo($campaignId, $keywordId, $contentType, $updateKeywordRequest, $contentType);
        return $response;
    }
     ...
     */
    public function updateKeywordWithHttpInfo($campaignId, $keywordId, $contentType, $updateKeywordRequest, string $contentType = self::contentTypes['updateKeyword'][0])
    {
        $request = $this->updateKeywordRequest($campaignId, $keywordId, $contentType, $updateKeywordRequest, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateKeywordAsync($campaignId, $keywordId, $contentType, $updateKeywordRequest, string $contentType = self::contentTypes['updateKeyword'][0])
    {
        return $this->updateKeywordAsyncWithHttpInfo($campaignId, $keywordId, $contentType, $updateKeywordRequest, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateKeywordAsyncWithHttpInfo($campaignId, $keywordId, $contentType, $updateKeywordRequest, string $contentType = self::contentTypes['updateKeyword'][0])
    {
        $returnType = '\macropage\SDKs\ebay\rest\marketing\Model\UpdateKeywordResponse';
        $request = $this->updateKeywordRequest($campaignId, $keywordId, $contentType, $updateKeywordRequest, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateKeywordRequest($campaignId, $keywordId, $contentType, $updateKeywordRequest, string $contentType = self::contentTypes['updateKeyword'][0])
    {
        ...
        if ($contentType === null || (is_array($contentType) && count($contentType) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $contentType when calling updateKeyword'
            );
        }
