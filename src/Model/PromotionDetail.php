...
class PromotionDetail implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets couponCode
     *
     * @param string|null $couponCode A unique code that buyers can use during checkout to receive a discount. The code must be unique across eBay.
     *
     * @return self
     */
     ...
     * Sets promotionHref
     *
     * @param string|null $promotionHref The URI of the promotion details.
     *
     * @return self
     */
     ...
     *
     * @param string|null $promotionStatus The current status of the promotion. When creating a new promotion, you must set this value to either <code>DRAFT</code> or <code>SCHEDULED</code>. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/marketing/types/sme:PromotionStatusEnum'>eBay API documentation</a>
     *
     * @return self
     */
