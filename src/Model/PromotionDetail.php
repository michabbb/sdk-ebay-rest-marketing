...
class PromotionDetail implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name The seller-defined name or \"title\" of the discount, such as \"Buy 1 Get 1\", that the seller can use to identify a discount. This label is not displayed in end-user flows.  <br><br><b>Maximum length:</b> 90
     *
     * @return self
     */
     ...
     * Sets promotionHref
     *
     * @param string|null $promotionHref The URI of the discount details.
     *
     * @return self
     */
     ...
     *
     * @param string|null $promotionStatus The current status of the discount. When creating a new discount, you must set this value to either <code>DRAFT</code> or <code>SCHEDULED</code>. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/marketing/types/sme:PromotionStatusEnum'>eBay API documentation</a>
     *
     * @return self
     */
