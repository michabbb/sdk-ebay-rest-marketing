...
class KeywordPagedCollectionResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'href' => 'string',
        'keywords' => '\macropage\SDKs\ebay\rest\marketing\Model\Keyword[]',
        'limit' => 'int',
        'next' => 'string',
        'offset' => 'int',
        'prev' => 'string',
    ...
    */
     ...
     * Gets keywords
     *
     * @return \macropage\SDKs\ebay\rest\marketing\Model\Keyword[]|null
     */
