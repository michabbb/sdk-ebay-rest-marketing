...
class UpdateCampaignRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets categoryId
     *
     * @param string|null $categoryId The unique identifier of either an eBay category or a store category.<br><br>This field is used if a seller wants to apply an email campaign to a specific eBay category or store category. The <b>categoryType</b> determines whether the <b>categoryId</b> value is an eBay category or store category.<br><br>To retrieve eBay categories, use the <a href=\"/devzone/xml/docs/reference/ebay/GetCategories.html\" target=\"_blank\">getCategories</a> or Taxonomy API. To retrieve seller store categories, use the <a href=\"/devzone/xml/docs/reference/ebay/GetStore.html\" target=\"_blank\">getStore</a> call. Use the <b>categoryId</b> value of the desired category from the results as the value in the request.<br><br><b>itemSelectMode</b> must be set to <code>AUTO</code> in order to use a category ID.
     *
     * @return self
     */
     ...
     *
     * @param string|null $personalizedMessage The body of the email campaign. Accepts HTML and CSS. The maximum length is 1000 characters
     *
     * @return self
     */
     ...
     * Sets subject
     *
     * @param string|null $subject The email campaign subject. The maximum length is 70 characters.
     *
     * @return self
     */
