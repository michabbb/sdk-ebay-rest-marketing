...
class ItemPromotionResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param bool|null $applyDiscountToSingleItemOnly If set to <code>true</code>, the discount is applied only when the buyer purchases multiple quantities of a single item in the promotion. Otherwise, the promotional discount applies to multiple quantities of any items in the promotion. Different variations of a multi-variation item are considered to be the same item. Note that this flag is not relevant if the <b>inventoryCriterion</b> container identifies a single listing ID for the promotion.
     *
     * @return self
     */
     ...
     * Sets discountRules
     *
     * @param \macropage\SDKs\ebay\rest\marketing\Model\DiscountRule[]|null $discountRules A list containing the promotion benefits (<b>discountRule</b>) and the rules that define when the benefit is applied (<b>discountSpecification</b>).
     *
     * @return self
     */
     ...
     * Sets promotionId
     *
     * @param string|null $promotionId A unique eBay-assigned ID for the promotion that's generated when the promotion is created.
     *
     * @return self
     */
     ...
     *
     * @param string|null $promotionStatus The current status of the promotion. When creating a new promotion, this value must be set to either <code>DRAFT</code> or <code>SCHEDULED</code>. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/marketing/types/sme:PromotionStatusEnum'>eBay API documentation</a>
     *
     * @return self
     */
