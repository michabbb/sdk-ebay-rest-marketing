...
/**
 * SuggestBudgetResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class SuggestBudgetResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SuggestBudgetResponse';
    ...
    protected static $openAPITypes = [
        'suggestedBudget' => '\macropage\SDKs\ebay\rest\marketing\Model\BudgetRecommendationResponse[]'
    ];
    ...
    */
     ...
     *
     * @return \macropage\SDKs\ebay\rest\marketing\Model\BudgetRecommendationResponse[]|null
     */
     ...
     *
     * @param \macropage\SDKs\ebay\rest\marketing\Model\BudgetRecommendationResponse[]|null $suggestedBudget The suggested allocated daily budget for an Offsite Ads campaign.
     *
     * @return self
     */
    public function setSuggestedBudget($suggestedBudget)
    {
        if (is_null($suggestedBudget)) {
            throw new \InvalidArgumentException('non-nullable suggestedBudget cannot be null');
        }
