...
class UpdateAdStatusByListingIdRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets adGroupId
     *
     * @param string|null $adGroupId A unique eBay-assigned ID for an ad group in a campaign that uses the Cost Per Click (CPC) funding model.<br /><br />Use the  <a href=\"/api-docs/sell/marketing/resources/adgroup/methods/getAdGroups\">getAdGroups</a> method to retrieve the ad group IDs for a seller.
     *
     * @return self
     */
     ...
     * Sets adStatus
     *
     * @param string|null $adStatus An enumeration value representing the current status of the ad.<br /><br /><b>Valid Values:</b><ul><li><code>ACTIVE</code></li><li><code>PAUSED</code></li><li><code>ARCHIVED</code></li></ul> For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/marketing/types/pls:AdStatusEnum'>eBay API documentation</a>
     *
     * @return self
     */
     ...
     * Sets listingId
     *
     * @param string|null $listingId A unique eBay-assigned identifier for a listing that is generated when the listing is created.<br /><br /><span class=\"tablenote\"><b>Note:</b> This field accepts both listing IDs (as generated by the Inventory API), and item IDs (as used in the eBay Traditional API set, such as the Trading and Finding APIs).</span>
     *
     * @return self
     */
