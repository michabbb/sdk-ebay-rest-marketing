...
class SummaryReportResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets lastUpdated
     *
     * @param string|null $lastUpdated The date the report was generated.
     *
     * @return self
     */
     ...
     *
     * @param string|null $percentageSalesLift The percentage of the total dollar amount gained due to promotions. This value is calculated as follows:  <br><br><b>precentageSalesLift</b> = <b>promotionSale</b> / (<b>baseSale</b> + <b>promotionSale</b>)
     *
     * @return self
     */
