...
class Campaign implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'alerts' => '\macropage\SDKs\ebay\rest\marketing\Model\Alert[]',
        'budget' => '\macropage\SDKs\ebay\rest\marketing\Model\CampaignBudget',
    ...
    */
     ...
     * Gets alerts
     *
     * @return \macropage\SDKs\ebay\rest\marketing\Model\Alert[]|null
     */
     ...
     * Sets alerts
     *
     * @param \macropage\SDKs\ebay\rest\marketing\Model\Alert[]|null $alerts This array contains alert messages for the campaign.
     *
     * @return self
     */
     ...
     * Gets budget
     *
     * @return \macropage\SDKs\ebay\rest\marketing\Model\CampaignBudget|null
     */
     ...
     * Sets budget
     *
     * @param \macropage\SDKs\ebay\rest\marketing\Model\CampaignBudget|null $budget budget
     *
     * @return self
     */
     ...
     * Sets campaignStatus
     *
     * @param string|null $campaignStatus Indicates the status of the campaign, such as <code>RUNNING</code>, <code>PAUSED</code>, and <code>ENDED</code>. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/marketing/types/pls:CampaignStatusEnum'>eBay API documentation</a>
     *
     * @return self
     */
     ...
     *
     * @param string|null $campaignTargetingType The targeting type of the campaign. This value indicates whether the campaign is a manual targeting or smart targeting ad campaign. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/marketing/types/pls:CampaignTargetingTypeEnum'>eBay API documentation</a>
     *
     * @return self
     */
     ...
     * Sets channels
     *
     * @param string[]|null $channels The channel for the campaign. This value indicates whether the campaign is an Onsite or Offsite advertising campaign. <br><br><b>Valid Values:</b><ul><li><code>ON_SITE</code></li><li><code>OFF_SITE</code></li></ul>
     *
     * @return self
     */
     ...
     * Sets marketplaceId
     *
     * @param string|null $marketplaceId The ID of the eBay marketplace where the campaign is hosted. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/marketing/types/ba:MarketplaceIdEnum'>eBay API documentation</a>
     *
     * @return self
     */
