...
class CreateAdsByInventoryReferenceResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets adGroupId
     *
     * @param string|null $adGroupId A unique eBay-assigned ID for an ad group in a Promoted Listings Advanced (PLA) campaign that uses the Cost Per Click (CPC) funding model.<span class=\"tablenote\"><b>Note:</b> This field will always be returned for campaigns that use the CPC funding model. It will not be returned for campaigns that use the Cost Per Sale (CPS) funding model.</span>
     *
     * @return self
     */
     ...
     * Sets ads
     *
     * @param \macropage\SDKs\ebay\rest\marketing\Model\AdReference[]|null $ads A list of ad IDs. An ad ID is generated for each successfully created ad.
     *
     * @return self
     */
     ...
     * Sets errors
     *
     * @param \macropage\SDKs\ebay\rest\marketing\Model\Error[]|null $errors An array of errors or warnings associated with the create-ads request.
     *
     * @return self
     */
     ...
     * Sets statusCode
     *
     * @param int|null $statusCode An HTTP status code that indicates the response-status of the request. Check this code to see if the ads were successfully created.
     *
     * @return self
     */
