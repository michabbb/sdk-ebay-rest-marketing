...
class RuleCriteria implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param \macropage\SDKs\ebay\rest\marketing\Model\InventoryItem[]|null $markupInventoryItems A list of SKUs to remove from a markdown promotion. The listed SKUs are 'marked up' to their standard price after being part of the markdown promotion.
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $markupListingIds A list of listing IDs to remove from a markdown promotion. The listed items are 'marked up' to their standard price after being part of the markdown promotion.
     *
     * @return self
     */
