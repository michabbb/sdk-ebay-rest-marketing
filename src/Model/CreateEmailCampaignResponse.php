...
class CreateEmailCampaignResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string|null $emailCampaignId The unique eBay-assigned identifier of the email campaign. It is generated automatically when the email campaign is created.<br><br>This value is returned unless there is an error.
     *
     * @return self
     */
     ...
     *
     * @param string|null $emailCampaignStatus The status of the email campaign.<br><br><code>ACTIVE</code> is returned for email campaigns that have been successfully created but not been sent.<br><br><code>SENT</code> is returned for email campaigns that have already been sent.<br><br><code>ERROR</code> is returned when an email has not been successfully created. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/marketing/types/api:EmailCampaignStatusEnum'>eBay API documentation</a>
     *
     * @return self
     */
