...
class SuggestedBids implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'keywordText' => 'string',
        'matchType' => 'string',
        'proposedBid' => '\macropage\SDKs\ebay\rest\marketing\Model\ProposedBid'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('proposedBid', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets keywordText
     *
     * @param string|null $keywordText The text for the keyword.
     *
     * @return self
     */
     ...
     * Gets proposedBid
     *
     * @return \macropage\SDKs\ebay\rest\marketing\Model\ProposedBid|null
     */
    public function getProposedBid()
    {
        return $this->container['proposedBid'];
    }

    /**
     * Sets proposedBid
     *
     * @param \macropage\SDKs\ebay\rest\marketing\Model\ProposedBid|null $proposedBid proposedBid
     *
     * @return self
     */
    public function setProposedBid($proposedBid)
    {
        if (is_null($proposedBid)) {
            throw new \InvalidArgumentException('non-nullable proposedBid cannot be null');
        }
        $this->container['proposedBid'] = $proposedBid;
