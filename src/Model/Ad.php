...
class Ad implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets adGroupId
     *
     * @param string|null $adGroupId A unique eBay-assigned ID for an ad group in a campaign that uses the Cost Per Click (CPC) funding model. This ID is created after a successful <a href=\"/api-docs/sell/marketing/resources/adgroup/methods/createAdGroup\">createAdGroup</a> call, and all ad groups must be associated with a CPC campaign.
     *
     * @return self
     */
     ...
     * Sets adId
     *
     * @param string|null $adId A unique eBay-assigned ID that is generated when the ad is created.
     *
     * @return self
     */
     ...
     * Sets alerts
     *
     * @param \macropage\SDKs\ebay\rest\marketing\Model\Alert[]|null $alerts An array containing alert messages for the ad.
     *
     * @return self
     */
     ...
     *
     * @param string|null $inventoryReferenceType The enumeration value returned here indicates the type of listing the inventoryReferenceId references. The value returned here will be <code>INVENTORY_ITEM</code> for a single-variation listing, or <code>INVENTORY_ITEM_GROUP</code> for a multiple-variation listing. <p>This field is only returned if the ad is associated with a SKU or an inventory item group value.</p> For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/marketing/types/pls:InventoryReferenceTypeEnum'>eBay API documentation</a>
     *
     * @return self
     */
     ...
     * Sets listingId
     *
     * @param string|null $listingId A unique eBay-assigned ID that is generated when a listing is created.
     *
     * @return self
     */
