...
/**
 * UpdateEmailCampaignResponse Class Doc Comment
 *
 * @category Class
 * @package  macropage\SDKs\ebay\rest\marketing
 * @author   OpenAPI Generator team
 ...
 */
class UpdateEmailCampaignResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateEmailCampaignResponse';
    ...
    */
     ...
     *
     * @param string|null $emailCampaignId The unique eBay-assigned ID to the email campaign that is generated when the email campaign is created.
     *
     * @return self
     */
