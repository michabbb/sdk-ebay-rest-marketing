...
class GetEmailCampaignResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets promotionId
     *
     * @param string|null $promotionId The ID of the discount that was assigned to the email campaign.
     *
     * @return self
     */
     ...
     *
     * @param string|null $promotionSelectMode Indicates whether the listings that the discount was applied to were selected manually or automatically.<br><br>This field will only return if a discount was applied. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/marketing/types/api:PromotionSelectModeEnum'>eBay API documentation</a>
     *
     * @return self
     */
