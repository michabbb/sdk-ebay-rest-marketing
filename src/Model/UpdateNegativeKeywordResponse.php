...
class UpdateNegativeKeywordResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets errors
     *
     * @param \macropage\SDKs\ebay\rest\marketing\Model\Error[]|null $errors A container that will be returned if there are one or more issues associated with modifying the corresponding negative keyword.
     *
     * @return self
     */
     ...
     * Sets statusCode
     *
     * @param int|null $statusCode An HTTP status code that indicates the success or failure of updating that negative keyword.
     *
     * @return self
     */
