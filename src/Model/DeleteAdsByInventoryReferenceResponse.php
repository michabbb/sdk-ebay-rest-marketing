...
class DeleteAdsByInventoryReferenceResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets adIds
     *
     * @param string[]|null $adIds The unique identifier of the ad that was deleted, or the ad that the seller attempted to delete.<span class=\"tablenote\"><b>Note:</b>Although the field name is plural and it is an array, only one ad ID will be returned here since there can be only one ad per listing.</span>
     *
     * @return self
     */
    ...
    {
        if (is_null($adIds)) {
            throw new \InvalidArgumentException('non-nullable adIds cannot be null');
        }
     ...
     * Sets errors
     *
     * @param \macropage\SDKs\ebay\rest\marketing\Model\Error[]|null $errors The container for the errors associated with the request.
     *
     * @return self
     */
     ...
     *
     * @param string|null $inventoryReferenceId The inventory reference ID is a seller-defined SKU value for a single-item listing, or a seller-defined identifier for an inventory item group. Both of these values are defined when using the Inventory API, and an inventory item group is used to create a multiple-variation listing.
     *
     * @return self
     */
     ...
     *
     * @param string|null $inventoryReferenceType The enumeration value returned here indicates if the ad was for a single-variation listing or a multiple-variation listing. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/marketing/types/pls:InventoryReferenceTypeEnum'>eBay API documentation</a>
     *
     * @return self
     */
