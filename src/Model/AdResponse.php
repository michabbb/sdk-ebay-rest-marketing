...
class AdResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets adId
     *
     * @param string|null $adId A unique eBay-assigned ID for an ad. This ID is generated when an ad is created.<span class=\"tablenote\"><b>Note:</b>This field is only returned when an ad is successfully created for the corresponding listing.</span>
     *
     * @return self
     */
     ...
     * Sets errors
     *
     * @param \macropage\SDKs\ebay\rest\marketing\Model\Error[]|null $errors An array of errors associated with the request.
     *
     * @return self
     */
