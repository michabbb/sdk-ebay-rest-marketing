...
/**
 * SuggestMaxCpcRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class SuggestMaxCpcRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SuggestMaxCpcRequest';
    ...
    */
     ...
     * Sets listingIds
     *
     * @param string[]|null $listingIds A comma delimited array of listing Ids the seller plans to associate with the smart targeting campaign for which the <b>maxCpc</b> will be suggested.
     *
     * @return self
     */
     ...
     * Sets marketplaceId
     *
     * @param string|null $marketplaceId The unique identifier of the marketplace where the listings are hosted. See <a href=\"/api-docs/sell/marketing/types/ba:MarketplaceIdEnum\" target=\"_blank \">MarketplaceIdEnum</a> for supported values. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/marketing/types/ba:MarketplaceIdEnum'>eBay API documentation</a>
     *
     * @return self
     */
