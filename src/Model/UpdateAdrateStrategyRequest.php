...
class UpdateAdrateStrategyRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets adRateStrategy
     *
     * @param string|null $adRateStrategy This field is used to change the current ad rate strategy for a Cost Per Sale (CPS) campaign. It is not needed if the ad rate strategy is not being changed for the campaign.<br><br><span class=\"tablenote\"><b>Note:</b> This field is not applicable for Offsite Ads campaigns.</span> For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/marketing/types/pls:AdRateStrategyEnum'>eBay API documentation</a>
     *
     * @return self
     */
