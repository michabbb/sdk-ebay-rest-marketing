...
class CampaignCriterion implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param bool|null $autoSelectFutureInventory A field used to indicate whether listings shall be automatically added to, or removed from, a Promoted Listings campaign based on the rules that have been configured for the campaign.<br /><br />If set to <code>true</code>, eBay adds all listings matching the campaign criterion to the campaign, including any new listings created from the items in a seller's inventory.<br /><br /><b>Default:</b> <code>false</code>
     *
     * @return self
     */
     ...
     * Sets selectionRules
     *
     * @param \macropage\SDKs\ebay\rest\marketing\Model\SelectionRule[]|null $selectionRules This container shows all of the rules/inclusion filters used to add listings to the campaign. For information on using the contained fields, see <a href= \"/api-docs/sell/static/marketing/using-the-selectionrules-container.html#Campaign \">Promoted Listing campaigns</a>.
     *
     * @return self
     */
