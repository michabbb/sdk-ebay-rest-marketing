...
class ItemPriceMarkdown implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param bool|null $autoSelectFutureInventory If set to <code>true</code>, eBay will automatically add inventory items to the markdown promotion if they meet the <b>selectedInventoryDiscounts</b> criteria specified for the markdown promotion.  <br><br><b>Default:</b> <code>false</code>
     *
     * @return self
     */
     ...
     *
     * @param string|null $promotionStatus The current status of the promotion. When creating a new promotion, you must set this value to either <code>DRAFT</code> or <code>SCHEDULED</code>.  <br><br>Note that you must set this value to <code>SCHEDULED</code> when you update a <b>RUNNING</b> promotion. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/marketing/types/sme:PromotionStatusEnum'>eBay API documentation</a>
     *
     * @return self
     */
     ...
     *
     * @param \macropage\SDKs\ebay\rest\marketing\Model\SelectedInventoryDiscount[]|null $selectedInventoryDiscounts A list that defines the sets of selected items for the markdown promotion and the discount specified for promotion.
     *
     * @return self
     */
