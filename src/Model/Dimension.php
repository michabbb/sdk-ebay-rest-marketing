...
class Dimension implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        'annotationKeys' => 'setAnnotationKeys',
    ...
    protected static $getters = [
        'annotationKeys' => 'getAnnotationKeys',
    ...
    {
        $this->setIfExists('annotationKeys', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['annotationKeys'];
    }

    /**
     * Sets annotationKeys
     *
     * @param string[]|null $annotationKeys A list of annotations associated with the dimension of the report.
     *
     * @return self
     */
    public function setAnnotationKeys($annotationKeys)
    {
        if (is_null($annotationKeys)) {
            throw new \InvalidArgumentException('non-nullable annotationKeys cannot be null');
        }
        $this->container['annotationKeys'] = $annotationKeys;
     ...
     * Sets dimensionKey
     *
     * @param string|null $dimensionKey The name of the dimension on which the report is based. <p>A dimension is an attribute to which the report data applies.</p>
     *
     * @return self
     */
