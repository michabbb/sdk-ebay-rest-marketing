...
/**
 * DeleteEmailCampaignResponse Class Doc Comment
 *
 * @category Class
 * @package  macropage\SDKs\ebay\rest\marketing
 * @author   OpenAPI Generator team
 ...
 */
class DeleteEmailCampaignResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeleteEmailCampaignResponse';
    ...
    */
     ...
     *
     * @param string|null $emailCampaignId The unique eBay-assigned ID for the email campaign that is generated when the email campaign is created.
     *
     * @return self
     */
