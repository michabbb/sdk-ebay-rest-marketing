...
class UpdateAdsByInventoryReferenceResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'ads' => '\macropage\SDKs\ebay\rest\marketing\Model\AdReference[]',
    ...
    */
     ...
     * Gets ads
     *
     * @return \macropage\SDKs\ebay\rest\marketing\Model\AdReference[]|null
     */
     ...
     * Sets ads
     *
     * @param \macropage\SDKs\ebay\rest\marketing\Model\AdReference[]|null $ads A list of ad IDs and links to retrieve them.
     *
     * @return self
     */
     ...
     * Sets errors
     *
     * @param \macropage\SDKs\ebay\rest\marketing\Model\Error[]|null $errors A container for all of the errors associated with the specified inventory reference ID.
     *
     * @return self
     */
     ...
     *
     * @param string|null $inventoryReferenceId The reference ID associated with the ad. The reference ID could be a SKU number or Inventory Item Group, depending on value of <code>inventoryReferenceType</code>.
     *
     * @return self
     */
     ...
     *
     * @param string|null $inventoryReferenceType The inventory reference type associated with the ad. The inventory reference type could be a SKU number or Inventory Item Group. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/marketing/types/pls:InventoryReferenceTypeEnum'>eBay API documentation</a>
     *
     * @return self
     */
     ...
     * Sets statusCode
     *
     * @param int|null $statusCode An HTTP status code that indicates whether or not the CPS ad was successfully updated.
     *
     * @return self
     */
