...
class CreateNegativeKeywordRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets campaignId
     *
     * @param string|null $campaignId This path parameter specifies the unique eBay-assigned identifier of the ad campaign associated with the set of negative keywords being created. <br><br> Use the <a href=\"/api-docs/sell/marketing/resources/campaign/methods/getCampaigns\" target=\"_blank\">getCampaigns</a> method to retrieve campaign IDs.<br /><br /><i>Required if</i> the negative keyword is being created at the ad group level.
     *
     * @return self
     */
     ...
     *
     * @param string|null $negativeKeywordText The negative keyword text.
     *
     * @return self
     */
