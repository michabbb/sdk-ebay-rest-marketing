...
/**
 * UpdateBiddingStrategyRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class UpdateBiddingStrategyRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateBiddingStrategyRequest';
    ...
    */
     ...
     *
     * @param string|null $biddingStrategy The new bidding strategy for the specified Cost Per Click (CPC) campaign. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/marketing/types/pls:BiddingStrategyEnum'>eBay API documentation</a>
     *
     * @return self
     */
