...
class UpdateAdStatusRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets adId
     *
     * @param string|null $adId A unique eBay-assigned identifier for an ad that belongs to the specified campaign.<br><br> Use the <a href=\"/api-docs/sell/marketing/resources/ad/methods/getAds\">getAds</a> method to retrieve ad IDs.
     *
     * @return self
     */
     ...
     * Sets adStatus
     *
     * @param string|null $adStatus An enumeration value representing the status you wish to update the specified ad to.<br /><br /><b>Valid Values:</b><ul><li><code>ACTIVE</code></li><li><code>PAUSED</code></li><li><code>ARCHIVED</code></li></ul> For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/marketing/types/pls:AdStatusEnum'>eBay API documentation</a>
     *
     * @return self
     */
