...
class NegativeKeywordResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets adGroupId
     *
     * @param string|null $adGroupId A unique identifier for an ad group that is generated when an ad group is first created and associated with a campaign.
     *
     * @return self
     */
     ...
     * Sets errors
     *
     * @param \macropage\SDKs\ebay\rest\marketing\Model\Error[]|null $errors This container will be returned if there is an issue creating the corresponding negative keyword.
     *
     * @return self
     */
     ...
     *
     * @param string|null $negativeKeywordId A unique eBay-assigned ID for a negative keyword. This negative keyword ID will be generated for each successfully created negative keyword.
     *
     * @return self
     */
     ...
     * Sets statusCode
     *
     * @param int|null $statusCode The status of the request to create a negative keyword. This field indicates whether the process was successful or not.
     *
     * @return self
     */
