...
class KeywordResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets adGroupId
     *
     * @param string|null $adGroupId The identifier of the ad group that the keyword was added to.
     *
     * @return self
     */
     ...
     * Sets errors
     *
     * @param \macropage\SDKs\ebay\rest\marketing\Model\Error[]|null $errors This container will be returned if there is an issue creating the corresponding keyword and/or adding that keyword to the corresponding ad group.
     *
     * @return self
     */
     ...
     * Sets keywordId
     *
     * @param string|null $keywordId A unique eBay-assigned ID for a keyword that is generated for an ad group. This keyword ID will be generated for each successfully created keyword.
     *
     * @return self
     */
     ...
     * Sets statusCode
     *
     * @param int|null $statusCode An HTTP status code is returned for each keyword to indicate the success or failure of adding that keyword to the ad group.
     *
     * @return self
     */
     ...
     * Sets warnings
     *
     * @param \macropage\SDKs\ebay\rest\marketing\Model\Error[]|null $warnings List of warnings associated with this operation
     *
     * @return self
     */
