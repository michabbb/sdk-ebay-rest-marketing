...
------------ | ------------- | ------------- | -------------
**campaigns** | [**\macropage\SDKs\ebay\rest\marketing\Model\Campaign[]**](Campaign.md) | This array contains all of the seller&#39;s campaign that match the request criteria. | [optional]
