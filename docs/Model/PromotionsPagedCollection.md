...
**promotions** | [**\macropage\SDKs\ebay\rest\marketing\Model\PromotionDetail[]**](PromotionDetail.md) | A list containing the details of each returned discount. This includes all the information about the discounts except for the listings that are discounted. | [optional]
