...
**promotions** | [**\macropage\SDKs\ebay\rest\marketing\Model\PromotionDetail[]**](PromotionDetail.md) | A list containing the details of each returned promotion. This includes all the information about the promotions except for the listings that are part of the promotions. | [optional]
