...
------------ | ------------- | ------------- | -------------
**adGroups** | [**\macropage\SDKs\ebay\rest\marketing\Model\AdGroup[]**](AdGroup.md) | The details of existing ad groups, such as the name, ID, and status of the ad groups. | [optional]
