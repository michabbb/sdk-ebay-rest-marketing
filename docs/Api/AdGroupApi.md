...
```php
createAdGroup($campaignId, $createAdGroupRequest): object
```
...
try {
    $result = $apiInstance->createAdGroup($campaignId, $createAdGroupRequest);
    print_r($result);
} catch (Exception $e) {
...
```php
suggestBids($adGroupId, $campaignId, $targetedBidRequest): \macropage\SDKs\ebay\rest\marketing\Model\TargetedBidsPagedCollection
```
...
try {
    $result = $apiInstance->suggestBids($adGroupId, $campaignId, $targetedBidRequest);
    print_r($result);
} catch (Exception $e) {
...
```php
suggestKeywords($adGroupId, $campaignId, $targetedKeywordRequest): \macropage\SDKs\ebay\rest\marketing\Model\TargetedKeywordsPagedCollection
```
...
try {
    $result = $apiInstance->suggestKeywords($adGroupId, $campaignId, $targetedKeywordRequest);
    print_r($result);
} catch (Exception $e) {
