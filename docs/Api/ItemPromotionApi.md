...
```php
createItemPromotion($contentType, $itemPromotion): \macropage\SDKs\ebay\rest\marketing\Model\BaseResponse
```
...
$itemPromotion = new \macropage\SDKs\ebay\rest\marketing\Model\ItemPromotion(); // \macropage\SDKs\ebay\rest\marketing\Model\ItemPromotion | This type defines the fields that describe an item promotion.

try {
    $result = $apiInstance->createItemPromotion($contentType, $itemPromotion);
    print_r($result);
} catch (Exception $e) {
...
| **itemPromotion** | [**\macropage\SDKs\ebay\rest\marketing\Model\ItemPromotion**](../Model/ItemPromotion.md)| This type defines the fields that describe an item promotion. | [optional] |
...
```php
updateItemPromotion($promotionId, $contentType, $itemPromotion): \macropage\SDKs\ebay\rest\marketing\Model\BaseResponse
```
...
try {
    $result = $apiInstance->updateItemPromotion($promotionId, $contentType, $itemPromotion);
    print_r($result);
} catch (Exception $e) {
